...
func (a *CredentialMappingsAPIService) CredentialMappingsListExecute(r ApiCredentialMappingsListRequest) (*PaginatedCredentialMappingList, *http.Response, error) {
	...
	if r.credId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "cred_id", r.credId, "form", "")
	}
	if r.engagement != nil {
	...
	if r.isAuthnProvider != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "is_authn_provider", r.isAuthnProvider, "form", "")
	}
	if r.limit != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "limit", r.limit, "form", "")
	}
