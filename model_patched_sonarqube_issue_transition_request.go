...
type _PatchedSonarqubeIssueTransitionRequest PatchedSonarqubeIssueTransitionRequest
...
func (o *PatchedSonarqubeIssueTransitionRequest) UnmarshalJSON(data []byte) (err error) {
	varPatchedSonarqubeIssueTransitionRequest := _PatchedSonarqubeIssueTransitionRequest{}

	err = json.Unmarshal(data, &varPatchedSonarqubeIssueTransitionRequest)

	if err != nil {
		return err
	}

	*o = PatchedSonarqubeIssueTransitionRequest(varPatchedSonarqubeIssueTransitionRequest)
