...
func (a *JiraFindingMappingsAPIService) JiraFindingMappingsListExecute(r ApiJiraFindingMappingsListRequest) (*PaginatedJIRAIssueList, *http.Response, error) {
	...
	if r.findingGroup != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "finding_group", r.findingGroup, "form", "")
	}
	if r.id != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "id", r.id, "form", "")
	}
	if r.jiraId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "jira_id", r.jiraId, "form", "")
	}
	if r.jiraKey != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "jira_key", r.jiraKey, "form", "")
	}
	if r.limit != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "limit", r.limit, "form", "")
	}
