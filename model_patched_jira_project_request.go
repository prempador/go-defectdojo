...
type PatchedJIRAProjectRequest struct {
	...
	// Automatically create JIRA tickets for verified findings, assuming enforce_verified_status is True, or for all findings otherwise. Once linked, the JIRA ticket will continue to sync, regardless of status in DefectDojo.
	...
	// When disabled, Findings will no longer be pushed to Jira, even if they have already been pushed previously.
...
type _PatchedJIRAProjectRequest PatchedJIRAProjectRequest
...
func (o *PatchedJIRAProjectRequest) UnmarshalJSON(data []byte) (err error) {
	varPatchedJIRAProjectRequest := _PatchedJIRAProjectRequest{}

	err = json.Unmarshal(data, &varPatchedJIRAProjectRequest)

	if err != nil {
		return err
	}

	*o = PatchedJIRAProjectRequest(varPatchedJIRAProjectRequest)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "default_assignee")
		delete(additionalProperties, "jira_labels")
		delete(additionalProperties, "add_vulnerability_id_to_jira_label")
		delete(additionalProperties, "push_all_issues")
		delete(additionalProperties, "enable_engagement_epic_mapping")
		delete(additionalProperties, "epic_issue_type_name")
		delete(additionalProperties, "push_notes")
		delete(additionalProperties, "product_jira_sla_notification")
		delete(additionalProperties, "risk_acceptance_expiration_notification")
