...
func (a *ProductsAPIService) ProductsListExecute(r ApiProductsListRequest) (*PaginatedProductList, *http.Response, error) {
	...
	if r.businessCriticality != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "business_criticality", r.businessCriticality, "form", "")
	}
	if r.created != nil {
	...
	if r.externalAudience != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "external_audience", r.externalAudience, "form", "")
	}
	if r.hasTags != nil {
	...
	if r.internetAccessible != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "internet_accessible", r.internetAccessible, "form", "")
	}
	if r.lifecycle != nil {
	...
	if r.nameExact != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "name_exact", r.nameExact, "form", "")
	}
	if r.notTag != nil {
	...
	if r.prodNumericGrade != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "prod_numeric_grade", r.prodNumericGrade, "form", "csv")
	}
	if r.prodType != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "prod_type", r.prodType, "form", "csv")
	}
	if r.productManager != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "product_manager", r.productManager, "form", "csv")
	}
	if r.regulations != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "regulations", r.regulations, "form", "csv")
	}
	if r.revenue != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "revenue", r.revenue, "form", "")
	}
	if r.tag != nil {
	...
	if r.teamManager != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "team_manager", r.teamManager, "form", "csv")
	}
	if r.technicalContact != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "technical_contact", r.technicalContact, "form", "csv")
	}
	if r.tid != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "tid", r.tid, "form", "csv")
	}
	if r.updated != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "updated", r.updated, "form", "")
	}
	if r.userRecords != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "user_records", r.userRecords, "form", "csv")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
