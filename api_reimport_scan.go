...
// Force findings to be active/inactive or default to the original tool (None)
func (r ApiReimportScanCreateRequest) Active(active bool) ApiReimportScanCreateRequest {
	r.active = &active
	return r
}

// Force findings to be verified/not verified or default to the original tool (None)
...
// Choose an option to automatically group new findings by the chosen option.  * &#x60;component_name&#x60; - Component Name * &#x60;component_name+component_version&#x60; - Component Name + Version * &#x60;file_path&#x60; - File path * &#x60;finding_title&#x60; - Finding Title * &#x60;vuln_id_from_tool&#x60; - Vulnerability ID from Tool
...
func (r ApiReimportScanCreateRequest) ApplyTagsToEndpoints(applyTagsToEndpoints bool) ApiReimportScanCreateRequest {
	r.applyTagsToEndpoints = &applyTagsToEndpoints
	return r
}
...
// Old findings no longer present in the new report get closed as mitigated when importing. If service has been set, only the findings for this service will be closed. This only affects findings within the same test.
...
func (a *ReimportScanAPIService) ReimportScanCreateExecute(r ApiReimportScanCreateRequest) (*ReImportScan, *http.Response, error) {
	...
	if r.applyTagsToEndpoints != nil {
		parameterAddToHeaderOrQuery(localVarFormParams, "apply_tags_to_endpoints", r.applyTagsToEndpoints, "")
	}
