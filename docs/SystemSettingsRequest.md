...
**EnableWebhooksNotifications** | Pointer to **bool** |  | [optional] 
**WebhooksNotificationsTimeout** | Pointer to **int32** | How many seconds will DefectDojo waits for response from webhook endpoint | [optional] 
**EnforceVerifiedStatus** | Pointer to **bool** | When enabled, features such as product grading, jira integration, metrics, and reports will only interact with verified findings. This setting will override individually scoped verified toggles. | [optional] 
**EnforceVerifiedStatusJira** | Pointer to **bool** | When enabled, findings must have a verified status to be pushed to jira. | [optional] 
**EnforceVerifiedStatusProductGrading** | Pointer to **bool** | When enabled, findings must have a verified status to be considered as part of a product&#39;s grading. | [optional] 
**EnforceVerifiedStatusMetrics** | Pointer to **bool** | When enabled, findings must have a verified status to be counted in metric calculations, be included in reports, and filters. | [optional] 
...
**DisclaimerNotifications** | Pointer to **string** | Include this custom disclaimer on all notifications | [optional] 
**DisclaimerReports** | Pointer to **string** | Include this custom disclaimer on generated reports | [optional] 
**DisclaimerReportsForced** | Pointer to **bool** | Disclaimer will be added to all reports even if user didn&#39;t selected &#39;Include disclaimer&#39;. | [optional] 
**DisclaimerNotes** | Pointer to **string** | Include this custom disclaimer next to input form for notes | [optional] 
...
**EnableCvss3Display** | Pointer to **bool** | With this setting turned off, CVSS3 fields will be hidden in the user interface. | [optional] 
**EnableCvss4Display** | Pointer to **bool** | With this setting turned off, CVSS4 fields will be hidden in the user interface. | [optional] 
...
### GetEnableWebhooksNotifications

`func (o *SystemSettingsRequest) GetEnableWebhooksNotifications() bool`

GetEnableWebhooksNotifications returns the EnableWebhooksNotifications field if non-nil, zero value otherwise.

### GetEnableWebhooksNotificationsOk

`func (o *SystemSettingsRequest) GetEnableWebhooksNotificationsOk() (*bool, bool)`

GetEnableWebhooksNotificationsOk returns a tuple with the EnableWebhooksNotifications field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetEnableWebhooksNotifications

`func (o *SystemSettingsRequest) SetEnableWebhooksNotifications(v bool)`

SetEnableWebhooksNotifications sets EnableWebhooksNotifications field to given value.

### HasEnableWebhooksNotifications

`func (o *SystemSettingsRequest) HasEnableWebhooksNotifications() bool`

HasEnableWebhooksNotifications returns a boolean if a field has been set.

### GetWebhooksNotificationsTimeout

`func (o *SystemSettingsRequest) GetWebhooksNotificationsTimeout() int32`

GetWebhooksNotificationsTimeout returns the WebhooksNotificationsTimeout field if non-nil, zero value otherwise.

### GetWebhooksNotificationsTimeoutOk

`func (o *SystemSettingsRequest) GetWebhooksNotificationsTimeoutOk() (*int32, bool)`

GetWebhooksNotificationsTimeoutOk returns a tuple with the WebhooksNotificationsTimeout field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetWebhooksNotificationsTimeout

`func (o *SystemSettingsRequest) SetWebhooksNotificationsTimeout(v int32)`

SetWebhooksNotificationsTimeout sets WebhooksNotificationsTimeout field to given value.

### HasWebhooksNotificationsTimeout

`func (o *SystemSettingsRequest) HasWebhooksNotificationsTimeout() bool`

HasWebhooksNotificationsTimeout returns a boolean if a field has been set.

### GetEnforceVerifiedStatus

`func (o *SystemSettingsRequest) GetEnforceVerifiedStatus() bool`

GetEnforceVerifiedStatus returns the EnforceVerifiedStatus field if non-nil, zero value otherwise.

### GetEnforceVerifiedStatusOk

`func (o *SystemSettingsRequest) GetEnforceVerifiedStatusOk() (*bool, bool)`

GetEnforceVerifiedStatusOk returns a tuple with the EnforceVerifiedStatus field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetEnforceVerifiedStatus

`func (o *SystemSettingsRequest) SetEnforceVerifiedStatus(v bool)`

SetEnforceVerifiedStatus sets EnforceVerifiedStatus field to given value.

### HasEnforceVerifiedStatus

`func (o *SystemSettingsRequest) HasEnforceVerifiedStatus() bool`

HasEnforceVerifiedStatus returns a boolean if a field has been set.

### GetEnforceVerifiedStatusJira

`func (o *SystemSettingsRequest) GetEnforceVerifiedStatusJira() bool`

GetEnforceVerifiedStatusJira returns the EnforceVerifiedStatusJira field if non-nil, zero value otherwise.

### GetEnforceVerifiedStatusJiraOk

`func (o *SystemSettingsRequest) GetEnforceVerifiedStatusJiraOk() (*bool, bool)`

GetEnforceVerifiedStatusJiraOk returns a tuple with the EnforceVerifiedStatusJira field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetEnforceVerifiedStatusJira

`func (o *SystemSettingsRequest) SetEnforceVerifiedStatusJira(v bool)`

SetEnforceVerifiedStatusJira sets EnforceVerifiedStatusJira field to given value.

### HasEnforceVerifiedStatusJira

`func (o *SystemSettingsRequest) HasEnforceVerifiedStatusJira() bool`

HasEnforceVerifiedStatusJira returns a boolean if a field has been set.

### GetEnforceVerifiedStatusProductGrading

`func (o *SystemSettingsRequest) GetEnforceVerifiedStatusProductGrading() bool`

GetEnforceVerifiedStatusProductGrading returns the EnforceVerifiedStatusProductGrading field if non-nil, zero value otherwise.

### GetEnforceVerifiedStatusProductGradingOk

`func (o *SystemSettingsRequest) GetEnforceVerifiedStatusProductGradingOk() (*bool, bool)`

GetEnforceVerifiedStatusProductGradingOk returns a tuple with the EnforceVerifiedStatusProductGrading field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetEnforceVerifiedStatusProductGrading

`func (o *SystemSettingsRequest) SetEnforceVerifiedStatusProductGrading(v bool)`

SetEnforceVerifiedStatusProductGrading sets EnforceVerifiedStatusProductGrading field to given value.

### HasEnforceVerifiedStatusProductGrading

`func (o *SystemSettingsRequest) HasEnforceVerifiedStatusProductGrading() bool`

HasEnforceVerifiedStatusProductGrading returns a boolean if a field has been set.

### GetEnforceVerifiedStatusMetrics

`func (o *SystemSettingsRequest) GetEnforceVerifiedStatusMetrics() bool`

GetEnforceVerifiedStatusMetrics returns the EnforceVerifiedStatusMetrics field if non-nil, zero value otherwise.

### GetEnforceVerifiedStatusMetricsOk

`func (o *SystemSettingsRequest) GetEnforceVerifiedStatusMetricsOk() (*bool, bool)`

GetEnforceVerifiedStatusMetricsOk returns a tuple with the EnforceVerifiedStatusMetrics field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetEnforceVerifiedStatusMetrics

`func (o *SystemSettingsRequest) SetEnforceVerifiedStatusMetrics(v bool)`

SetEnforceVerifiedStatusMetrics sets EnforceVerifiedStatusMetrics field to given value.

### HasEnforceVerifiedStatusMetrics

`func (o *SystemSettingsRequest) HasEnforceVerifiedStatusMetrics() bool`
...
`func (o *SystemSettingsRequest) GetEnableSimilarFindings() bool`
...
`func (o *SystemSettingsRequest) GetEnableSimilarFindingsOk() (*bool, bool)`
...
`func (o *SystemSettingsRequest) SetEnableSimilarFindings(v bool)`

SetEnableSimilarFindings sets EnableSimilarFindings field to given value.

### HasEnableSimilarFindings

`func (o *SystemSettingsRequest) HasEnableSimilarFindings() bool`
...
### GetDisclaimerNotifications

`func (o *SystemSettingsRequest) GetDisclaimerNotifications() string`

GetDisclaimerNotifications returns the DisclaimerNotifications field if non-nil, zero value otherwise.

### GetDisclaimerNotificationsOk

`func (o *SystemSettingsRequest) GetDisclaimerNotificationsOk() (*string, bool)`

GetDisclaimerNotificationsOk returns a tuple with the DisclaimerNotifications field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetDisclaimerNotifications

`func (o *SystemSettingsRequest) SetDisclaimerNotifications(v string)`

SetDisclaimerNotifications sets DisclaimerNotifications field to given value.

### HasDisclaimerNotifications

`func (o *SystemSettingsRequest) HasDisclaimerNotifications() bool`

HasDisclaimerNotifications returns a boolean if a field has been set.

### GetDisclaimerReports

`func (o *SystemSettingsRequest) GetDisclaimerReports() string`

GetDisclaimerReports returns the DisclaimerReports field if non-nil, zero value otherwise.

### GetDisclaimerReportsOk

`func (o *SystemSettingsRequest) GetDisclaimerReportsOk() (*string, bool)`

GetDisclaimerReportsOk returns a tuple with the DisclaimerReports field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetDisclaimerReports

`func (o *SystemSettingsRequest) SetDisclaimerReports(v string)`

SetDisclaimerReports sets DisclaimerReports field to given value.

### HasDisclaimerReports

`func (o *SystemSettingsRequest) HasDisclaimerReports() bool`

HasDisclaimerReports returns a boolean if a field has been set.

### GetDisclaimerReportsForced

`func (o *SystemSettingsRequest) GetDisclaimerReportsForced() bool`

GetDisclaimerReportsForced returns the DisclaimerReportsForced field if non-nil, zero value otherwise.

### GetDisclaimerReportsForcedOk

`func (o *SystemSettingsRequest) GetDisclaimerReportsForcedOk() (*bool, bool)`

GetDisclaimerReportsForcedOk returns a tuple with the DisclaimerReportsForced field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetDisclaimerReportsForced

`func (o *SystemSettingsRequest) SetDisclaimerReportsForced(v bool)`

SetDisclaimerReportsForced sets DisclaimerReportsForced field to given value.

### HasDisclaimerReportsForced

`func (o *SystemSettingsRequest) HasDisclaimerReportsForced() bool`

HasDisclaimerReportsForced returns a boolean if a field has been set.

### GetDisclaimerNotes

`func (o *SystemSettingsRequest) GetDisclaimerNotes() string`

GetDisclaimerNotes returns the DisclaimerNotes field if non-nil, zero value otherwise.

### GetDisclaimerNotesOk

`func (o *SystemSettingsRequest) GetDisclaimerNotesOk() (*string, bool)`

GetDisclaimerNotesOk returns a tuple with the DisclaimerNotes field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetDisclaimerNotes

`func (o *SystemSettingsRequest) SetDisclaimerNotes(v string)`

SetDisclaimerNotes sets DisclaimerNotes field to given value.

### HasDisclaimerNotes

`func (o *SystemSettingsRequest) HasDisclaimerNotes() bool`
...
`func (o *SystemSettingsRequest) GetEnableUiTableBasedSearching() bool`
...
`func (o *SystemSettingsRequest) GetEnableUiTableBasedSearchingOk() (*bool, bool)`
...
`func (o *SystemSettingsRequest) SetEnableUiTableBasedSearching(v bool)`

SetEnableUiTableBasedSearching sets EnableUiTableBasedSearching field to given value.

### HasEnableUiTableBasedSearching

`func (o *SystemSettingsRequest) HasEnableUiTableBasedSearching() bool`
...
### GetEnableCvss3Display

`func (o *SystemSettingsRequest) GetEnableCvss3Display() bool`

GetEnableCvss3Display returns the EnableCvss3Display field if non-nil, zero value otherwise.

### GetEnableCvss3DisplayOk

`func (o *SystemSettingsRequest) GetEnableCvss3DisplayOk() (*bool, bool)`

GetEnableCvss3DisplayOk returns a tuple with the EnableCvss3Display field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetEnableCvss3Display

`func (o *SystemSettingsRequest) SetEnableCvss3Display(v bool)`

SetEnableCvss3Display sets EnableCvss3Display field to given value.

### HasEnableCvss3Display

`func (o *SystemSettingsRequest) HasEnableCvss3Display() bool`

HasEnableCvss3Display returns a boolean if a field has been set.

### GetEnableCvss4Display

`func (o *SystemSettingsRequest) GetEnableCvss4Display() bool`

GetEnableCvss4Display returns the EnableCvss4Display field if non-nil, zero value otherwise.

### GetEnableCvss4DisplayOk

`func (o *SystemSettingsRequest) GetEnableCvss4DisplayOk() (*bool, bool)`

GetEnableCvss4DisplayOk returns a tuple with the EnableCvss4Display field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetEnableCvss4Display

`func (o *SystemSettingsRequest) SetEnableCvss4Display(v bool)`

SetEnableCvss4Display sets EnableCvss4Display field to given value.

### HasEnableCvss4Display

`func (o *SystemSettingsRequest) HasEnableCvss4Display() bool`
...
`func (o *SystemSettingsRequest) GetFilterStringMatching() bool`

GetFilterStringMatching returns the FilterStringMatching field if non-nil, zero value otherwise.

### GetFilterStringMatchingOk

`func (o *SystemSettingsRequest) GetFilterStringMatchingOk() (*bool, bool)`
...
`func (o *SystemSettingsRequest) SetFilterStringMatching(v bool)`

SetFilterStringMatching sets FilterStringMatching field to given value.

### HasFilterStringMatching

`func (o *SystemSettingsRequest) HasFilterStringMatching() bool`
