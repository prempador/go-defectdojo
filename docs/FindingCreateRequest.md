...
`func (o *FindingCreateRequest) GetKnownExploited() bool`

GetKnownExploited returns the KnownExploited field if non-nil, zero value otherwise.

### GetKnownExploitedOk

`func (o *FindingCreateRequest) GetKnownExploitedOk() (*bool, bool)`
...
`func (o *FindingCreateRequest) SetKnownExploited(v bool)`

SetKnownExploited sets KnownExploited field to given value.

### HasKnownExploited

`func (o *FindingCreateRequest) HasKnownExploited() bool`

HasKnownExploited returns a boolean if a field has been set.

### GetRansomwareUsed

`func (o *FindingCreateRequest) GetRansomwareUsed() bool`

GetRansomwareUsed returns the RansomwareUsed field if non-nil, zero value otherwise.

### GetRansomwareUsedOk

`func (o *FindingCreateRequest) GetRansomwareUsedOk() (*bool, bool)`
...
`func (o *FindingCreateRequest) SetRansomwareUsed(v bool)`

SetRansomwareUsed sets RansomwareUsed field to given value.

### HasRansomwareUsed

`func (o *FindingCreateRequest) HasRansomwareUsed() bool`

HasRansomwareUsed returns a boolean if a field has been set.

### GetKevDate

`func (o *FindingCreateRequest) GetKevDate() string`

GetKevDate returns the KevDate field if non-nil, zero value otherwise.

### GetKevDateOk

`func (o *FindingCreateRequest) GetKevDateOk() (*string, bool)`
...
`func (o *FindingCreateRequest) SetKevDate(v string)`

SetKevDate sets KevDate field to given value.

### HasKevDate

`func (o *FindingCreateRequest) HasKevDate() bool`

HasKevDate returns a boolean if a field has been set.

### SetKevDateNil

`func (o *FindingCreateRequest) SetKevDateNil(b bool)`

 SetKevDateNil sets the value for KevDate to be an explicit nil

### UnsetKevDate
`func (o *FindingCreateRequest) UnsetKevDate()`
...
`func (o *FindingCreateRequest) GetCvssv4() string`

GetCvssv4 returns the Cvssv4 field if non-nil, zero value otherwise.

### GetCvssv4Ok

`func (o *FindingCreateRequest) GetCvssv4Ok() (*string, bool)`
...
`func (o *FindingCreateRequest) SetCvssv4Score(v float64)`

SetCvssv4Score sets Cvssv4Score field to given value.

### HasCvssv4Score

`func (o *FindingCreateRequest) HasCvssv4Score() bool`

HasCvssv4Score returns a boolean if a field has been set.

### SetCvssv4ScoreNil

`func (o *FindingCreateRequest) SetCvssv4ScoreNil(b bool)`

 SetCvssv4ScoreNil sets the value for Cvssv4Score to be an explicit nil

### UnsetCvssv4Score
`func (o *FindingCreateRequest) UnsetCvssv4Score()`
...
`func (o *FindingCreateRequest) GetFixAvailable() bool`

GetFixAvailable returns the FixAvailable field if non-nil, zero value otherwise.

### GetFixAvailableOk

`func (o *FindingCreateRequest) GetFixAvailableOk() (*bool, bool)`
...
`func (o *FindingCreateRequest) SetFixAvailable(v bool)`

SetFixAvailable sets FixAvailable field to given value.

### HasFixAvailable

`func (o *FindingCreateRequest) HasFixAvailable() bool`

HasFixAvailable returns a boolean if a field has been set.

### SetFixAvailableNil

`func (o *FindingCreateRequest) SetFixAvailableNil(b bool)`

 SetFixAvailableNil sets the value for FixAvailable to be an explicit nil

### UnsetFixAvailable
`func (o *FindingCreateRequest) UnsetFixAvailable()`
