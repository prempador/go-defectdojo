...
### NewPatchedFindingRequestWithDefaults
...
`func (o *PatchedFindingRequest) GetKnownExploited() bool`

GetKnownExploited returns the KnownExploited field if non-nil, zero value otherwise.

### GetKnownExploitedOk

`func (o *PatchedFindingRequest) GetKnownExploitedOk() (*bool, bool)`
...
`func (o *PatchedFindingRequest) SetKnownExploited(v bool)`

SetKnownExploited sets KnownExploited field to given value.

### HasKnownExploited

`func (o *PatchedFindingRequest) HasKnownExploited() bool`

HasKnownExploited returns a boolean if a field has been set.

### GetRansomwareUsed

`func (o *PatchedFindingRequest) GetRansomwareUsed() bool`

GetRansomwareUsed returns the RansomwareUsed field if non-nil, zero value otherwise.

### GetRansomwareUsedOk

`func (o *PatchedFindingRequest) GetRansomwareUsedOk() (*bool, bool)`
...
`func (o *PatchedFindingRequest) SetRansomwareUsed(v bool)`

SetRansomwareUsed sets RansomwareUsed field to given value.

### HasRansomwareUsed

`func (o *PatchedFindingRequest) HasRansomwareUsed() bool`

HasRansomwareUsed returns a boolean if a field has been set.

### GetKevDate

`func (o *PatchedFindingRequest) GetKevDate() string`

GetKevDate returns the KevDate field if non-nil, zero value otherwise.

### GetKevDateOk

`func (o *PatchedFindingRequest) GetKevDateOk() (*string, bool)`
...
`func (o *PatchedFindingRequest) SetKevDate(v string)`

SetKevDate sets KevDate field to given value.

### HasKevDate

`func (o *PatchedFindingRequest) HasKevDate() bool`

HasKevDate returns a boolean if a field has been set.

### SetKevDateNil

`func (o *PatchedFindingRequest) SetKevDateNil(b bool)`

 SetKevDateNil sets the value for KevDate to be an explicit nil

### UnsetKevDate
`func (o *PatchedFindingRequest) UnsetKevDate()`
...
`func (o *PatchedFindingRequest) GetCvssv4() string`

GetCvssv4 returns the Cvssv4 field if non-nil, zero value otherwise.

### GetCvssv4Ok

`func (o *PatchedFindingRequest) GetCvssv4Ok() (*string, bool)`
...
`func (o *PatchedFindingRequest) SetCvssv4Score(v float64)`

SetCvssv4Score sets Cvssv4Score field to given value.

### HasCvssv4Score

`func (o *PatchedFindingRequest) HasCvssv4Score() bool`

HasCvssv4Score returns a boolean if a field has been set.

### SetCvssv4ScoreNil

`func (o *PatchedFindingRequest) SetCvssv4ScoreNil(b bool)`

 SetCvssv4ScoreNil sets the value for Cvssv4Score to be an explicit nil

### UnsetCvssv4Score
`func (o *PatchedFindingRequest) UnsetCvssv4Score()`
...
`func (o *PatchedFindingRequest) GetFixAvailable() bool`

GetFixAvailable returns the FixAvailable field if non-nil, zero value otherwise.

### GetFixAvailableOk

`func (o *PatchedFindingRequest) GetFixAvailableOk() (*bool, bool)`
...
`func (o *PatchedFindingRequest) SetFixAvailable(v bool)`

SetFixAvailable sets FixAvailable field to given value.

### HasFixAvailable

`func (o *PatchedFindingRequest) HasFixAvailable() bool`

HasFixAvailable returns a boolean if a field has been set.

### SetFixAvailableNil

`func (o *PatchedFindingRequest) SetFixAvailableNil(b bool)`

 SetFixAvailableNil sets the value for FixAvailable to be an explicit nil

### UnsetFixAvailable
`func (o *PatchedFindingRequest) UnsetFixAvailable()`
...
`func (o *PatchedFindingRequest) SetComponentVersionNil(b bool)`
...
`func (o *PatchedFindingRequest) SetPublishDateNil(b bool)`
