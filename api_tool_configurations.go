...
func (r ApiToolConfigurationsListRequest) Prefetch(prefetch []string) ApiToolConfigurationsListRequest {
	r.prefetch = &prefetch
	return r
}
...
func (a *ToolConfigurationsAPIService) ToolConfigurationsListExecute(r ApiToolConfigurationsListRequest) (*PaginatedToolConfigurationList, *http.Response, error) {
	...
	if r.authenticationType != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "authentication_type", r.authenticationType, "form", "")
	}
	if r.id != nil {
	...
	if r.toolType != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "tool_type", r.toolType, "form", "")
	}
	if r.url != nil {
...
// List of fields for which to prefetch model instances and add those to the response
func (r ApiToolConfigurationsRetrieveRequest) Prefetch(prefetch []string) ApiToolConfigurationsRetrieveRequest {
	r.prefetch = &prefetch
	return r
}
