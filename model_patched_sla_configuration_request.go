...
type PatchedSLAConfigurationRequest struct {
	...
	RestartSlaOnReactivation *bool `json:"restart_sla_on_reactivation,omitempty"`
...
// GetRestartSlaOnReactivation returns the RestartSlaOnReactivation field value if set, zero value otherwise.
func (o *PatchedSLAConfigurationRequest) GetRestartSlaOnReactivation() bool {
	if o == nil || IsNil(o.RestartSlaOnReactivation) {
		var ret bool
		return ret
	}
	return *o.RestartSlaOnReactivation
}

// GetRestartSlaOnReactivationOk returns a tuple with the RestartSlaOnReactivation field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PatchedSLAConfigurationRequest) GetRestartSlaOnReactivationOk() (*bool, bool) {
	if o == nil || IsNil(o.RestartSlaOnReactivation) {
		return nil, false
	}
	return o.RestartSlaOnReactivation, true
}
...
// SetRestartSlaOnReactivation gets a reference to the given bool and assigns it to the RestartSlaOnReactivation field.
func (o *PatchedSLAConfigurationRequest) SetRestartSlaOnReactivation(v bool) {
	o.RestartSlaOnReactivation = &v
}
...
func (o PatchedSLAConfigurationRequest) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RestartSlaOnReactivation) {
		toSerialize["restart_sla_on_reactivation"] = o.RestartSlaOnReactivation
	}
...
func (o *PatchedSLAConfigurationRequest) UnmarshalJSON(data []byte) (err error) {
	...
	*o = PatchedSLAConfigurationRequest(varPatchedSLAConfigurationRequest)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "restart_sla_on_reactivation")
