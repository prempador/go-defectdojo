...
type _LanguagePrefetch LanguagePrefetch
...
func (o *LanguagePrefetch) UnmarshalJSON(data []byte) (err error) {
	varLanguagePrefetch := _LanguagePrefetch{}

	err = json.Unmarshal(data, &varLanguagePrefetch)

	if err != nil {
		return err
	}

	*o = LanguagePrefetch(varLanguagePrefetch)
