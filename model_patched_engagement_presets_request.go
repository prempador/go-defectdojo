...
type _PatchedEngagementPresetsRequest PatchedEngagementPresetsRequest
...
func (o *PatchedEngagementPresetsRequest) UnmarshalJSON(data []byte) (err error) {
	varPatchedEngagementPresetsRequest := _PatchedEngagementPresetsRequest{}

	err = json.Unmarshal(data, &varPatchedEngagementPresetsRequest)

	if err != nil {
		return err
	}

	*o = PatchedEngagementPresetsRequest(varPatchedEngagementPresetsRequest)
