...
type _DojoGroupPrefetch DojoGroupPrefetch
...
func (o *DojoGroupPrefetch) UnmarshalJSON(data []byte) (err error) {
	varDojoGroupPrefetch := _DojoGroupPrefetch{}

	err = json.Unmarshal(data, &varDojoGroupPrefetch)

	if err != nil {
		return err
	}

	*o = DojoGroupPrefetch(varDojoGroupPrefetch)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "product_groups")
		delete(additionalProperties, "product_type_groups")
