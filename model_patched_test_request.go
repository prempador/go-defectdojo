...
type _PatchedTestRequest PatchedTestRequest
...
func (o *PatchedTestRequest) UnmarshalJSON(data []byte) (err error) {
	varPatchedTestRequest := _PatchedTestRequest{}

	err = json.Unmarshal(data, &varPatchedTestRequest)

	if err != nil {
		return err
	}

	*o = PatchedTestRequest(varPatchedTestRequest)
