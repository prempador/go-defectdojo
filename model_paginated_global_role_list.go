...
// checks if the PaginatedGlobalRoleList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedGlobalRoleList{}

// PaginatedGlobalRoleList struct for PaginatedGlobalRoleList
type PaginatedGlobalRoleList struct {
	Count int32 `json:"count"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results []GlobalRole `json:"results"`
	Prefetch *DojoGroupMemberPrefetch `json:"prefetch,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _PaginatedGlobalRoleList PaginatedGlobalRoleList
...
func (o *PaginatedGlobalRoleList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedGlobalRoleList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o PaginatedGlobalRoleList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedGlobalRoleList) ToMap() (map[string]interface{}, error) {
...
func (o *PaginatedGlobalRoleList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedGlobalRoleList := _PaginatedGlobalRoleList{}

	err = json.Unmarshal(data, &varPaginatedGlobalRoleList)

	if err != nil {
		return err
	}

	*o = PaginatedGlobalRoleList(varPaginatedGlobalRoleList)
...
type NullablePaginatedGlobalRoleList struct {
	value *PaginatedGlobalRoleList
	isSet bool
}

func (v NullablePaginatedGlobalRoleList) Get() *PaginatedGlobalRoleList {
	return v.value
}

func (v *NullablePaginatedGlobalRoleList) Set(val *PaginatedGlobalRoleList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedGlobalRoleList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedGlobalRoleList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedGlobalRoleList(val *PaginatedGlobalRoleList) *NullablePaginatedGlobalRoleList {
	return &NullablePaginatedGlobalRoleList{value: val, isSet: true}
}

func (v NullablePaginatedGlobalRoleList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedGlobalRoleList) UnmarshalJSON(src []byte) error {
	v.isSet = true
