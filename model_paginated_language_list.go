...
// checks if the PaginatedLanguageList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedLanguageList{}

// PaginatedLanguageList struct for PaginatedLanguageList
...
type _PaginatedLanguageList PaginatedLanguageList
...
func (o *PaginatedLanguageList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedLanguageList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o PaginatedLanguageList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedLanguageList) ToMap() (map[string]interface{}, error) {
...
func (o *PaginatedLanguageList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedLanguageList := _PaginatedLanguageList{}

	err = json.Unmarshal(data, &varPaginatedLanguageList)

	if err != nil {
		return err
	}

	*o = PaginatedLanguageList(varPaginatedLanguageList)
...
type NullablePaginatedLanguageList struct {
	value *PaginatedLanguageList
	isSet bool
}

func (v NullablePaginatedLanguageList) Get() *PaginatedLanguageList {
	return v.value
}

func (v *NullablePaginatedLanguageList) Set(val *PaginatedLanguageList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedLanguageList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedLanguageList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedLanguageList(val *PaginatedLanguageList) *NullablePaginatedLanguageList {
	return &NullablePaginatedLanguageList{value: val, isSet: true}
}

func (v NullablePaginatedLanguageList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedLanguageList) UnmarshalJSON(src []byte) error {
	v.isSet = true
