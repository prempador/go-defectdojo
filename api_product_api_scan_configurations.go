...
func (r ApiProductApiScanConfigurationsListRequest) Prefetch(prefetch []string) ApiProductApiScanConfigurationsListRequest {
	r.prefetch = &prefetch
	return r
}
...
func (a *ProductApiScanConfigurationsAPIService) ProductApiScanConfigurationsListExecute(r ApiProductApiScanConfigurationsListRequest) (*PaginatedProductAPIScanConfigurationList, *http.Response, error) {
	...
	if r.serviceKey1 != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "service_key_1", r.serviceKey1, "form", "")
	}
	if r.serviceKey2 != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "service_key_2", r.serviceKey2, "form", "")
	}
	if r.serviceKey3 != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "service_key_3", r.serviceKey3, "form", "")
	}
...
// List of fields for which to prefetch model instances and add those to the response
func (r ApiProductApiScanConfigurationsRetrieveRequest) Prefetch(prefetch []string) ApiProductApiScanConfigurationsRetrieveRequest {
	r.prefetch = &prefetch
	return r
}
