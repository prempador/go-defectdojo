...
type PaginatedDojoGroupMemberList struct {
	...
	Results []DojoGroupMember `json:"results"`
	Prefetch *DojoGroupMemberPrefetch `json:"prefetch,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _PaginatedDojoGroupMemberList PaginatedDojoGroupMemberList
...
func (o *PaginatedDojoGroupMemberList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedDojoGroupMemberList := _PaginatedDojoGroupMemberList{}

	err = json.Unmarshal(data, &varPaginatedDojoGroupMemberList)

	if err != nil {
		return err
	}

	*o = PaginatedDojoGroupMemberList(varPaginatedDojoGroupMemberList)
