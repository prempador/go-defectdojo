...
// checks if the StatusStatisticsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StatusStatisticsRequest{}

// StatusStatisticsRequest struct for StatusStatisticsRequest
type StatusStatisticsRequest struct {
...
type _StatusStatisticsRequest StatusStatisticsRequest
...
func (o StatusStatisticsRequest) MarshalJSON() ([]byte, error) {
...
func (o StatusStatisticsRequest) ToMap() (map[string]interface{}, error) {
...
func (o *StatusStatisticsRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varStatusStatisticsRequest := _StatusStatisticsRequest{}

	err = json.Unmarshal(data, &varStatusStatisticsRequest)

	if err != nil {
		return err
	}

	*o = StatusStatisticsRequest(varStatusStatisticsRequest)
...
type NullableStatusStatisticsRequest struct {
	value *StatusStatisticsRequest
	isSet bool
}

func (v NullableStatusStatisticsRequest) Get() *StatusStatisticsRequest {
	return v.value
}

func (v *NullableStatusStatisticsRequest) Set(val *StatusStatisticsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableStatusStatisticsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableStatusStatisticsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStatusStatisticsRequest(val *StatusStatisticsRequest) *NullableStatusStatisticsRequest {
	return &NullableStatusStatisticsRequest{value: val, isSet: true}
}

func (v NullableStatusStatisticsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStatusStatisticsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
