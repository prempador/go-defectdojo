...
type _PatchedEndpointStatusRequest PatchedEndpointStatusRequest
...
func (o *PatchedEndpointStatusRequest) UnmarshalJSON(data []byte) (err error) {
	varPatchedEndpointStatusRequest := _PatchedEndpointStatusRequest{}

	err = json.Unmarshal(data, &varPatchedEndpointStatusRequest)

	if err != nil {
		return err
	}

	*o = PatchedEndpointStatusRequest(varPatchedEndpointStatusRequest)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "false_positive")
