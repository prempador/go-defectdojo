...
type _TestImportRequest TestImportRequest
...
func (o *TestImportRequest) UnmarshalJSON(data []byte) (err error) {
	varTestImportRequest := _TestImportRequest{}

	err = json.Unmarshal(data, &varTestImportRequest)

	if err != nil {
		return err
	}

	*o = TestImportRequest(varTestImportRequest)
