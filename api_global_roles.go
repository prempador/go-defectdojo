...
func (r ApiGlobalRolesListRequest) Prefetch(prefetch []string) ApiGlobalRolesListRequest {
	r.prefetch = &prefetch
	return r
}
...
// List of fields for which to prefetch model instances and add those to the response
func (r ApiGlobalRolesRetrieveRequest) Prefetch(prefetch []string) ApiGlobalRolesRetrieveRequest {
	r.prefetch = &prefetch
	return r
}
