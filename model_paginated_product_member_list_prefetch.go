...
type _PaginatedProductMemberListPrefetch PaginatedProductMemberListPrefetch
...
func (o *PaginatedProductMemberListPrefetch) UnmarshalJSON(data []byte) (err error) {
	varPaginatedProductMemberListPrefetch := _PaginatedProductMemberListPrefetch{}

	err = json.Unmarshal(data, &varPaginatedProductMemberListPrefetch)

	if err != nil {
		return err
	}

	*o = PaginatedProductMemberListPrefetch(varPaginatedProductMemberListPrefetch)
