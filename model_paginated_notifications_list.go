...
type PaginatedNotificationsList struct {
	...
	Results []Notifications `json:"results"`
	Prefetch *AppAnalysisPrefetch `json:"prefetch,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _PaginatedNotificationsList PaginatedNotificationsList
...
func (o *PaginatedNotificationsList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedNotificationsList := _PaginatedNotificationsList{}

	err = json.Unmarshal(data, &varPaginatedNotificationsList)

	if err != nil {
		return err
	}

	*o = PaginatedNotificationsList(varPaginatedNotificationsList)
