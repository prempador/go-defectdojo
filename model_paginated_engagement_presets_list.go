...
// checks if the PaginatedEngagementPresetsList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedEngagementPresetsList{}

// PaginatedEngagementPresetsList struct for PaginatedEngagementPresetsList
type PaginatedEngagementPresetsList struct {
	Count int32 `json:"count"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results []EngagementPresets `json:"results"`
	Prefetch *EngagementPresetsPrefetch `json:"prefetch,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _PaginatedEngagementPresetsList PaginatedEngagementPresetsList
...
func NewPaginatedEngagementPresetsList(count int32, results []EngagementPresets) *PaginatedEngagementPresetsList {
	this := PaginatedEngagementPresetsList{}
	this.Count = count
...
func (o *PaginatedEngagementPresetsList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedEngagementPresetsList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o *PaginatedEngagementPresetsList) GetPrefetch() EngagementPresetsPrefetch {
	if o == nil || IsNil(o.Prefetch) {
		var ret EngagementPresetsPrefetch
		return ret
	}
	return *o.Prefetch
}
...
// SetPrefetch gets a reference to the given EngagementPresetsPrefetch and assigns it to the Prefetch field.
func (o *PaginatedEngagementPresetsList) SetPrefetch(v EngagementPresetsPrefetch) {
	o.Prefetch = &v
}

func (o PaginatedEngagementPresetsList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedEngagementPresetsList) ToMap() (map[string]interface{}, error) {
...
func (o *PaginatedEngagementPresetsList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedEngagementPresetsList := _PaginatedEngagementPresetsList{}

	err = json.Unmarshal(data, &varPaginatedEngagementPresetsList)

	if err != nil {
		return err
	}

	*o = PaginatedEngagementPresetsList(varPaginatedEngagementPresetsList)
...
type NullablePaginatedEngagementPresetsList struct {
	value *PaginatedEngagementPresetsList
	isSet bool
}

func (v NullablePaginatedEngagementPresetsList) Get() *PaginatedEngagementPresetsList {
	return v.value
}

func (v *NullablePaginatedEngagementPresetsList) Set(val *PaginatedEngagementPresetsList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedEngagementPresetsList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedEngagementPresetsList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedEngagementPresetsList(val *PaginatedEngagementPresetsList) *NullablePaginatedEngagementPresetsList {
	return &NullablePaginatedEngagementPresetsList{value: val, isSet: true}
}

func (v NullablePaginatedEngagementPresetsList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedEngagementPresetsList) UnmarshalJSON(src []byte) error {
	v.isSet = true
