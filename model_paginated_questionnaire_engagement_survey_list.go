...
type PaginatedQuestionnaireEngagementSurveyList struct {
	...
	Results []QuestionnaireEngagementSurvey `json:"results"`
	AdditionalProperties map[string]interface{}
}

type _PaginatedQuestionnaireEngagementSurveyList PaginatedQuestionnaireEngagementSurveyList
...
func (o *PaginatedQuestionnaireEngagementSurveyList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedQuestionnaireEngagementSurveyList := _PaginatedQuestionnaireEngagementSurveyList{}

	err = json.Unmarshal(data, &varPaginatedQuestionnaireEngagementSurveyList)

	if err != nil {
		return err
	}

	*o = PaginatedQuestionnaireEngagementSurveyList(varPaginatedQuestionnaireEngagementSurveyList)
