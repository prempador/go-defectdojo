...
type _PatchedAppAnalysisRequest PatchedAppAnalysisRequest
...
func (o *PatchedAppAnalysisRequest) UnmarshalJSON(data []byte) (err error) {
	varPatchedAppAnalysisRequest := _PatchedAppAnalysisRequest{}

	err = json.Unmarshal(data, &varPatchedAppAnalysisRequest)

	if err != nil {
		return err
	}

	*o = PatchedAppAnalysisRequest(varPatchedAppAnalysisRequest)
