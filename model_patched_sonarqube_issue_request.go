...
type _PatchedSonarqubeIssueRequest PatchedSonarqubeIssueRequest
...
func (o *PatchedSonarqubeIssueRequest) UnmarshalJSON(data []byte) (err error) {
	varPatchedSonarqubeIssueRequest := _PatchedSonarqubeIssueRequest{}

	err = json.Unmarshal(data, &varPatchedSonarqubeIssueRequest)

	if err != nil {
		return err
	}

	*o = PatchedSonarqubeIssueRequest(varPatchedSonarqubeIssueRequest)
