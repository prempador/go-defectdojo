...
func (o *ReportGenerate) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varReportGenerate)
	...
	*o = ReportGenerate(varReportGenerate)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "report_name")
		delete(additionalProperties, "report_info")
		...
		delete(additionalProperties, "finding_notes")
