...
type _TestImportFindingActionRequest TestImportFindingActionRequest
...
func (o *TestImportFindingActionRequest) UnmarshalJSON(data []byte) (err error) {
	varTestImportFindingActionRequest := _TestImportFindingActionRequest{}

	err = json.Unmarshal(data, &varTestImportFindingActionRequest)

	if err != nil {
		return err
	}

	*o = TestImportFindingActionRequest(varTestImportFindingActionRequest)
