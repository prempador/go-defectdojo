...
type PaginatedQuestionnaireGeneralSurveyList struct {
	...
	Results []QuestionnaireGeneralSurvey `json:"results"`
	AdditionalProperties map[string]interface{}
}

type _PaginatedQuestionnaireGeneralSurveyList PaginatedQuestionnaireGeneralSurveyList
...
func (o *PaginatedQuestionnaireGeneralSurveyList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedQuestionnaireGeneralSurveyList := _PaginatedQuestionnaireGeneralSurveyList{}

	err = json.Unmarshal(data, &varPaginatedQuestionnaireGeneralSurveyList)

	if err != nil {
		return err
	}

	*o = PaginatedQuestionnaireGeneralSurveyList(varPaginatedQuestionnaireGeneralSurveyList)
