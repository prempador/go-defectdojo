...
type PaginatedJIRAIssueList struct {
	...
	Results []JIRAIssue `json:"results"`
	AdditionalProperties map[string]interface{}
}

type _PaginatedJIRAIssueList PaginatedJIRAIssueList
...
func (o *PaginatedJIRAIssueList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedJIRAIssueList := _PaginatedJIRAIssueList{}

	err = json.Unmarshal(data, &varPaginatedJIRAIssueList)

	if err != nil {
		return err
	}

	*o = PaginatedJIRAIssueList(varPaginatedJIRAIssueList)
