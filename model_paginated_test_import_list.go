...
type PaginatedTestImportList struct {
	...
	Prefetch *PaginatedTestImportListPrefetch `json:"prefetch,omitempty"`
}
...
// SetResults gets a reference to the given []TestImport and assigns it to the Results field.
...
func (o *PaginatedTestImportList) GetPrefetch() PaginatedTestImportListPrefetch {
	if o == nil || IsNil(o.Prefetch) {
		var ret PaginatedTestImportListPrefetch
		return ret
	}
	return *o.Prefetch
}
...
// SetPrefetch gets a reference to the given PaginatedTestImportListPrefetch and assigns it to the Prefetch field.
