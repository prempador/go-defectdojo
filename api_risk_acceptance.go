...
type RiskAcceptanceAPI interface {
	...
	/*
	RiskAcceptanceCreate Method for RiskAcceptanceCreate

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiRiskAcceptanceCreateRequest
	*/
	RiskAcceptanceCreate(ctx context.Context) ApiRiskAcceptanceCreateRequest

	// RiskAcceptanceCreateExecute executes the request
	//  @return RiskAcceptance
	RiskAcceptanceCreateExecute(r ApiRiskAcceptanceCreateRequest) (*RiskAcceptance, *http.Response, error)
...
type ApiRiskAcceptanceCreateRequest struct {
	ctx context.Context
	ApiService RiskAcceptanceAPI
	riskAcceptanceRequest *RiskAcceptanceRequest
}

func (r ApiRiskAcceptanceCreateRequest) RiskAcceptanceRequest(riskAcceptanceRequest RiskAcceptanceRequest) ApiRiskAcceptanceCreateRequest {
	r.riskAcceptanceRequest = &riskAcceptanceRequest
	return r
}

func (r ApiRiskAcceptanceCreateRequest) Execute() (*RiskAcceptance, *http.Response, error) {
	return r.ApiService.RiskAcceptanceCreateExecute(r)
}
...
RiskAcceptanceCreate Method for RiskAcceptanceCreate
 ...
 @return ApiRiskAcceptanceCreateRequest
*/
func (a *RiskAcceptanceAPIService) RiskAcceptanceCreate(ctx context.Context) ApiRiskAcceptanceCreateRequest {
	return ApiRiskAcceptanceCreateRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return RiskAcceptance
func (a *RiskAcceptanceAPIService) RiskAcceptanceCreateExecute(r ApiRiskAcceptanceCreateRequest) (*RiskAcceptance, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RiskAcceptanceAPIService.RiskAcceptanceCreate")
	if err != nil {
...
func (a *RiskAcceptanceAPIService) RiskAcceptanceListExecute(r ApiRiskAcceptanceListRequest) (*PaginatedRiskAcceptanceList, *http.Response, error) {
	...
	if r.acceptedBy != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "accepted_by", r.acceptedBy, "form", "")
	}
	if r.acceptedFindings != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "accepted_findings", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "accepted_findings", t, "form", "multi")
		}
	}
	if r.decision != nil {
	...
	if r.decisionDetails != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "decision_details", r.decisionDetails, "form", "")
	}
	if r.expirationDate != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "expiration_date", r.expirationDate, "form", "")
	}
	if r.expirationDateHandled != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "expiration_date_handled", r.expirationDateHandled, "form", "")
	}
	if r.expirationDateWarned != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "expiration_date_warned", r.expirationDateWarned, "form", "")
	}
	if r.limit != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "limit", r.limit, "form", "")
	}
	...
	if r.notes != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "notes", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "notes", t, "form", "multi")
		}
	}
	if r.o != nil {
	...
	if r.reactivateExpired != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "reactivate_expired", r.reactivateExpired, "form", "")
	}
	if r.recommendation != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "recommendation", r.recommendation, "form", "")
	}
	if r.recommendationDetails != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "recommendation_details", r.recommendationDetails, "form", "")
	}
	if r.restartSlaExpired != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "restart_sla_expired", r.restartSlaExpired, "form", "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
