...
type _GlobalRoleRequest GlobalRoleRequest
...
func (o *GlobalRoleRequest) UnmarshalJSON(data []byte) (err error) {
	varGlobalRoleRequest := _GlobalRoleRequest{}

	err = json.Unmarshal(data, &varGlobalRoleRequest)

	if err != nil {
		return err
	}

	*o = GlobalRoleRequest(varGlobalRoleRequest)
