...
type _PatchedTestTypeRequest PatchedTestTypeRequest
...
func (o *PatchedTestTypeRequest) UnmarshalJSON(data []byte) (err error) {
	varPatchedTestTypeRequest := _PatchedTestTypeRequest{}

	err = json.Unmarshal(data, &varPatchedTestTypeRequest)

	if err != nil {
		return err
	}

	*o = PatchedTestTypeRequest(varPatchedTestTypeRequest)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "static_tool")
		delete(additionalProperties, "dynamic_tool")
