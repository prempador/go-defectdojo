...
type _PaginatedProductTypeList PaginatedProductTypeList
...
func (o *PaginatedProductTypeList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedProductTypeList := _PaginatedProductTypeList{}

	err = json.Unmarshal(data, &varPaginatedProductTypeList)

	if err != nil {
		return err
	}

	*o = PaginatedProductTypeList(varPaginatedProductTypeList)
