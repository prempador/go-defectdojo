...
type JIRAProject struct {
	...
	Prefetch *JIRAProjectPrefetch `json:"prefetch,omitempty"`
...
// SetPrefetch gets a reference to the given JIRAProjectPrefetch and assigns it to the Prefetch field.
...
func (o *JIRAProject) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varJIRAProject)
