...
type PaginatedSystemSettingsList struct {
	...
	Results []SystemSettings `json:"results"`
	AdditionalProperties map[string]interface{}
}

type _PaginatedSystemSettingsList PaginatedSystemSettingsList
...
func (o *PaginatedSystemSettingsList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedSystemSettingsList := _PaginatedSystemSettingsList{}

	err = json.Unmarshal(data, &varPaginatedSystemSettingsList)

	if err != nil {
		return err
	}

	*o = PaginatedSystemSettingsList(varPaginatedSystemSettingsList)
