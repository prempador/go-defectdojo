...
// checks if the SystemSettingsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemSettingsRequest{}

// SystemSettingsRequest struct for SystemSettingsRequest
...
type _SystemSettingsRequest SystemSettingsRequest
...
func (o *SystemSettingsRequest) SetMaxDupesNil() {
	o.MaxDupes.Set(nil)
}
...
func (o *SystemSettingsRequest) SetJiraWebhookSecretNil() {
...
func (o *SystemSettingsRequest) SetJiraMinimumSeverityNil() {
...
func (o *SystemSettingsRequest) SetJiraLabelsNil() {
...
func (o *SystemSettingsRequest) SetRiskAcceptanceFormDefaultDaysNil() {
...
func (o *SystemSettingsRequest) SetRiskAcceptanceNotifyBeforeExpirationNil() {
...
func (o *SystemSettingsRequest) SetDefaultGroupNil() {
...
func (o *SystemSettingsRequest) SetDefaultGroupRoleNil() {
...
func (o SystemSettingsRequest) MarshalJSON() ([]byte, error) {
...
func (o SystemSettingsRequest) ToMap() (map[string]interface{}, error) {
...
func (o *SystemSettingsRequest) UnmarshalJSON(data []byte) (err error) {
	varSystemSettingsRequest := _SystemSettingsRequest{}

	err = json.Unmarshal(data, &varSystemSettingsRequest)

	if err != nil {
		return err
	}

	*o = SystemSettingsRequest(varSystemSettingsRequest)
...
type NullableSystemSettingsRequest struct {
	value *SystemSettingsRequest
	isSet bool
}

func (v NullableSystemSettingsRequest) Get() *SystemSettingsRequest {
	return v.value
}

func (v *NullableSystemSettingsRequest) Set(val *SystemSettingsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSystemSettingsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSystemSettingsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSystemSettingsRequest(val *SystemSettingsRequest) *NullableSystemSettingsRequest {
	return &NullableSystemSettingsRequest{value: val, isSet: true}
}

func (v NullableSystemSettingsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSystemSettingsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
