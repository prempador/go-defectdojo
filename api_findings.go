...
type ApiFindingsAcceptRisksCreateRequest struct {
	...
	endpoints *[]int32
	epssPercentileMax *float64
	epssPercentileMin *float64
	epssScoreMax *float64
	epssScoreMin *float64
	falseP *bool
	filePath *string
	...
	testEngagementProductTagsAnd *[]string
	testEngagementTags *[]string
	testEngagementTagsAnd *[]string
	testTags *[]string
	testTagsAnd *[]string
	testTestType *[]int32
	title *string
...
func (r ApiFindingsAcceptRisksCreateRequest) Cvssv4(cvssv4 string) ApiFindingsAcceptRisksCreateRequest {
	r.cvssv4 = &cvssv4
	return r
}

func (r ApiFindingsAcceptRisksCreateRequest) Cvssv4Score(cvssv4Score float32) ApiFindingsAcceptRisksCreateRequest {
	r.cvssv4Score = &cvssv4Score
	return r
}
...
// The range of EPSS percentiles to filter on; the min input is a lower bound, the max is an upper bound. Leaving one empty will skip that bound (e.g., leaving the min bound input empty will filter only on the max bound -- filtering on \&quot;less than or equal\&quot;). Leading 0 required.
func (r ApiFindingsAcceptRisksCreateRequest) EpssPercentileMax(epssPercentileMax float64) ApiFindingsAcceptRisksCreateRequest {
	r.epssPercentileMax = &epssPercentileMax
	return r
}

// The range of EPSS percentiles to filter on; the min input is a lower bound, the max is an upper bound. Leaving one empty will skip that bound (e.g., leaving the min bound input empty will filter only on the max bound -- filtering on \&quot;less than or equal\&quot;). Leading 0 required.
func (r ApiFindingsAcceptRisksCreateRequest) EpssPercentileMin(epssPercentileMin float64) ApiFindingsAcceptRisksCreateRequest {
	r.epssPercentileMin = &epssPercentileMin
	return r
}

// The range of EPSS score percentages to filter on; the min input is a lower bound, the max is an upper bound. Leaving one empty will skip that bound (e.g., leaving the min bound input empty will filter only on the max bound -- filtering on \&quot;less than or equal\&quot;). Leading 0 required.
func (r ApiFindingsAcceptRisksCreateRequest) EpssScoreMax(epssScoreMax float64) ApiFindingsAcceptRisksCreateRequest {
	r.epssScoreMax = &epssScoreMax
	return r
}

// The range of EPSS score percentages to filter on; the min input is a lower bound, the max is an upper bound. Leaving one empty will skip that bound (e.g., leaving the min bound input empty will filter only on the max bound -- filtering on \&quot;less than or equal\&quot;). Leading 0 required.
func (r ApiFindingsAcceptRisksCreateRequest) EpssScoreMin(epssScoreMin float64) ApiFindingsAcceptRisksCreateRequest {
	r.epssScoreMin = &epssScoreMin
	return r
}
...
func (r ApiFindingsAcceptRisksCreateRequest) FixAvailable(fixAvailable bool) ApiFindingsAcceptRisksCreateRequest {
	r.fixAvailable = &fixAvailable
	return r
}
...
func (r ApiFindingsAcceptRisksCreateRequest) KevDate(kevDate string) ApiFindingsAcceptRisksCreateRequest {
	r.kevDate = &kevDate
	return r
}

func (r ApiFindingsAcceptRisksCreateRequest) KnownExploited(knownExploited bool) ApiFindingsAcceptRisksCreateRequest {
	r.knownExploited = &knownExploited
	return r
}
...
// Mitigated After
func (r ApiFindingsAcceptRisksCreateRequest) MitigatedAfter(mitigatedAfter time.Time) ApiFindingsAcceptRisksCreateRequest {
	r.mitigatedAfter = &mitigatedAfter
	return r
}

func (r ApiFindingsAcceptRisksCreateRequest) MitigatedBefore(mitigatedBefore time.Time) ApiFindingsAcceptRisksCreateRequest {
...
func (r ApiFindingsAcceptRisksCreateRequest) MitigatedOn(mitigatedOn time.Time) ApiFindingsAcceptRisksCreateRequest {
...
func (r ApiFindingsAcceptRisksCreateRequest) RansomwareUsed(ransomwareUsed bool) ApiFindingsAcceptRisksCreateRequest {
	r.ransomwareUsed = &ransomwareUsed
	return r
}
...
// Comma separated list of exact tags (uses OR for multiple values)
func (r ApiFindingsAcceptRisksCreateRequest) Tags(tags []string) ApiFindingsAcceptRisksCreateRequest {
	r.tags = &tags
	return r
}

// Comma separated list of exact tags to match with an AND expression
func (r ApiFindingsAcceptRisksCreateRequest) TagsAnd(tagsAnd []string) ApiFindingsAcceptRisksCreateRequest {
	r.tagsAnd = &tagsAnd
	return r
}
...
func (r ApiFindingsAcceptRisksCreateRequest) TestEngagementProductTagsAnd(testEngagementProductTagsAnd []string) ApiFindingsAcceptRisksCreateRequest {
	r.testEngagementProductTagsAnd = &testEngagementProductTagsAnd
	return r
}

// Comma separated list of exact tags present on engagement (uses OR for multiple values)
...
// Comma separated list of exact tags to match with an AND expression present on engagement
func (r ApiFindingsAcceptRisksCreateRequest) TestEngagementTagsAnd(testEngagementTagsAnd []string) ApiFindingsAcceptRisksCreateRequest {
	r.testEngagementTagsAnd = &testEngagementTagsAnd
	return r
}

// Comma separated list of exact tags present on test (uses OR for multiple values)
func (r ApiFindingsAcceptRisksCreateRequest) TestTags(testTags []string) ApiFindingsAcceptRisksCreateRequest {
	r.testTags = &testTags
	return r
}

// Comma separated list of exact tags to match with an AND expression present on test
func (r ApiFindingsAcceptRisksCreateRequest) TestTagsAnd(testTagsAnd []string) ApiFindingsAcceptRisksCreateRequest {
	r.testTagsAnd = &testTagsAnd
	return r
}
...
func (a *FindingsAPIService) FindingsAcceptRisksCreateExecute(r ApiFindingsAcceptRisksCreateRequest) (*PaginatedRiskAcceptanceList, *http.Response, error) {
	...
	if r.componentVersion != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "component_version", r.componentVersion, "")
	}
	if r.created != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "created", r.created, "")
	}
	if r.cvssv3 != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "cvssv3", r.cvssv3, "")
	}
	if r.cvssv3Score != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "cvssv3_score", r.cvssv3Score, "")
	}
	if r.cvssv4 != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "cvssv4", r.cvssv4, "")
	}
	if r.cvssv4Score != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "cvssv4_score", r.cvssv4Score, "")
	}
	if r.cwe != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "cwe", r.cwe, "csv")
	}
	if r.date != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "date", r.date, "")
	}
	if r.defectReviewRequestedBy != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "defect_review_requested_by", r.defectReviewRequestedBy, "csv")
	}
	if r.description != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "description", r.description, "")
	}
	if r.discoveredAfter != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "discovered_after", r.discoveredAfter, "")
	}
	if r.discoveredBefore != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "discovered_before", r.discoveredBefore, "")
	}
	if r.discoveredOn != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "discovered_on", r.discoveredOn, "")
	}
	if r.duplicate != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "duplicate", r.duplicate, "")
	}
	if r.duplicateFinding != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "duplicate_finding", r.duplicateFinding, "")
	}
	if r.dynamicFinding != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "dynamic_finding", r.dynamicFinding, "")
	}
	if r.effortForFixing != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "effort_for_fixing", r.effortForFixing, "")
	}
	if r.endpoints != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "endpoints", r.endpoints, "csv")
	}
	if r.epssPercentileMax != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "epss_percentile_max", r.epssPercentileMax, "")
	}
	if r.epssPercentileMin != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "epss_percentile_min", r.epssPercentileMin, "")
	}
	if r.epssScoreMax != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "epss_score_max", r.epssScoreMax, "")
	}
	if r.epssScoreMin != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "epss_score_min", r.epssScoreMin, "")
	}
	if r.falseP != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "false_p", r.falseP, "")
	}
	if r.filePath != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "file_path", r.filePath, "")
	}
	if r.findingGroup != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "finding_group", r.findingGroup, "csv")
	}
	if r.fixAvailable != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "fix_available", r.fixAvailable, "")
	}
	if r.foundBy != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "found_by", r.foundBy, "csv")
	}
	if r.hasJira != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "has_jira", r.hasJira, "")
	}
	if r.hasTags != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "has_tags", r.hasTags, "")
	}
	if r.hashCode != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "hash_code", r.hashCode, "")
	}
	if r.id != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "id", r.id, "csv")
	}
	if r.impact != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "impact", r.impact, "")
	}
	if r.inheritedTags != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "inherited_tags", s.Index(i).Interface(), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "inherited_tags", t, "multi")
		}
	}
	if r.isMitigated != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "is_mitigated", r.isMitigated, "")
	}
	if r.jiraChange != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "jira_change", r.jiraChange, "")
	}
	if r.jiraCreation != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "jira_creation", r.jiraCreation, "")
	}
	if r.kevDate != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "kev_date", r.kevDate, "")
	}
	if r.knownExploited != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "known_exploited", r.knownExploited, "")
	}
	if r.lastReviewed != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "last_reviewed", r.lastReviewed, "")
	}
	if r.lastReviewedBy != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "last_reviewed_by", r.lastReviewedBy, "csv")
	}
	if r.lastStatusUpdate != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "last_status_update", r.lastStatusUpdate, "")
	}
	if r.limit != nil {
	...
	if r.mitigatedAfter != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "mitigated_after", r.mitigatedAfter, "")
	}
	if r.mitigatedBefore != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "mitigated_before", r.mitigatedBefore, "")
	}
	if r.mitigatedBy != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "mitigated_by", r.mitigatedBy, "csv")
	}
	if r.mitigatedOn != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "mitigated_on", r.mitigatedOn, "")
	}
	if r.mitigation != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "mitigation", r.mitigation, "")
	}
	if r.nbOccurences != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "nb_occurences", r.nbOccurences, "csv")
	}
	if r.notTag != nil {
	...
	if r.notTestEngagementProductTags != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "not_test__engagement__product__tags", r.notTestEngagementProductTags, "csv")
	}
	if r.notTestEngagementTags != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "not_test__engagement__tags", r.notTestEngagementTags, "csv")
	}
	if r.notTestTags != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "not_test__tags", r.notTestTags, "csv")
	}
	if r.numericalSeverity != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "numerical_severity", r.numericalSeverity, "")
	}
	if r.o != nil {
	...
	if r.param != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "param", r.param, "")
	}
	if r.payload != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "payload", r.payload, "")
	}
	if r.plannedRemediationDate != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "planned_remediation_date", r.plannedRemediationDate, "")
	}
	if r.plannedRemediationVersion != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "planned_remediation_version", r.plannedRemediationVersion, "")
	}
	if r.productLifecycle != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "product_lifecycle", r.productLifecycle, "")
	}
	...
	if r.productNameContains != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "product_name_contains", r.productNameContains, "")
	}
	if r.publishDate != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "publish_date", r.publishDate, "")
	}
	if r.ransomwareUsed != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "ransomware_used", r.ransomwareUsed, "")
	}
	if r.references != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "references", r.references, "")
	}
	if r.reporter != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "reporter", r.reporter, "csv")
	}
	if r.reviewRequestedBy != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "review_requested_by", r.reviewRequestedBy, "csv")
	}
	if r.reviewers != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "reviewers", r.reviewers, "csv")
	}
	if r.riskAcceptance != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "risk_acceptance", r.riskAcceptance, "")
	}
	if r.riskAccepted != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "risk_accepted", r.riskAccepted, "")
	}
	if r.sastSinkObject != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "sast_sink_object", r.sastSinkObject, "")
	}
	if r.sastSourceFilePath != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "sast_source_file_path", r.sastSourceFilePath, "")
	}
	if r.sastSourceLine != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "sast_source_line", r.sastSourceLine, "csv")
	}
	if r.sastSourceObject != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "sast_source_object", r.sastSourceObject, "")
	}
	if r.scannerConfidence != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "scanner_confidence", r.scannerConfidence, "csv")
	}
	if r.service != nil {
	...
	if r.severityJustification != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "severity_justification", r.severityJustification, "")
	}
	if r.slaExpirationDate != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "sla_expiration_date", r.slaExpirationDate, "")
	}
	if r.slaStartDate != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "sla_start_date", r.slaStartDate, "")
	}
	if r.sonarqubeIssue != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "sonarqube_issue", r.sonarqubeIssue, "csv")
	}
	if r.staticFinding != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "static_finding", r.staticFinding, "")
	}
	if r.stepsToReproduce != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "steps_to_reproduce", r.stepsToReproduce, "")
	}
	if r.tag != nil {
	...
	if r.tagsAnd != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "tags__and", r.tagsAnd, "csv")
	}
	if r.test != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "test", r.test, "")
	}
	if r.testEngagement != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "test__engagement", r.testEngagement, "csv")
	}
	if r.testEngagementProduct != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "test__engagement__product", r.testEngagementProduct, "csv")
	}
	if r.testEngagementProductProdType != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "test__engagement__product__prod_type", r.testEngagementProductProdType, "csv")
	}
	if r.testEngagementProductTags != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "test__engagement__product__tags", r.testEngagementProductTags, "csv")
	}
	if r.testEngagementProductTagsAnd != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "test__engagement__product__tags__and", r.testEngagementProductTagsAnd, "csv")
	}
	if r.testEngagementTags != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "test__engagement__tags", r.testEngagementTags, "csv")
	}
	if r.testEngagementTagsAnd != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "test__engagement__tags__and", r.testEngagementTagsAnd, "csv")
	}
	if r.testTags != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "test__tags", r.testTags, "csv")
	}
	if r.testTagsAnd != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "test__tags__and", r.testTagsAnd, "csv")
	}
	if r.testTestType != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "test__test_type", r.testTestType, "csv")
	}
	if r.title != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "title", r.title, "")
	}
	if r.underDefectReview != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "under_defect_review", r.underDefectReview, "")
	}
	if r.underReview != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "under_review", r.underReview, "")
	}
	if r.uniqueIdFromTool != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "unique_id_from_tool", r.uniqueIdFromTool, "")
	}
	if r.verified != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "verified", r.verified, "")
	}
	if r.vulnIdFromTool != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "vuln_id_from_tool", r.vulnIdFromTool, "")
	}
	if r.vulnerabilityId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "vulnerability_id", r.vulnerabilityId, "")
	}
...
func (r ApiFindingsListRequest) Cvssv4(cvssv4 string) ApiFindingsListRequest {
	r.cvssv4 = &cvssv4
	return r
}

func (r ApiFindingsListRequest) Cvssv4Score(cvssv4Score float32) ApiFindingsListRequest {
	r.cvssv4Score = &cvssv4Score
	return r
}
...
// The range of EPSS percentiles to filter on; the min input is a lower bound, the max is an upper bound. Leaving one empty will skip that bound (e.g., leaving the min bound input empty will filter only on the max bound -- filtering on \&quot;less than or equal\&quot;). Leading 0 required.
func (r ApiFindingsListRequest) EpssPercentileMax(epssPercentileMax float64) ApiFindingsListRequest {
	r.epssPercentileMax = &epssPercentileMax
	return r
}

// The range of EPSS percentiles to filter on; the min input is a lower bound, the max is an upper bound. Leaving one empty will skip that bound (e.g., leaving the min bound input empty will filter only on the max bound -- filtering on \&quot;less than or equal\&quot;). Leading 0 required.
func (r ApiFindingsListRequest) EpssPercentileMin(epssPercentileMin float64) ApiFindingsListRequest {
	r.epssPercentileMin = &epssPercentileMin
	return r
}

// The range of EPSS score percentages to filter on; the min input is a lower bound, the max is an upper bound. Leaving one empty will skip that bound (e.g., leaving the min bound input empty will filter only on the max bound -- filtering on \&quot;less than or equal\&quot;). Leading 0 required.
func (r ApiFindingsListRequest) EpssScoreMax(epssScoreMax float64) ApiFindingsListRequest {
	r.epssScoreMax = &epssScoreMax
	return r
}

// The range of EPSS score percentages to filter on; the min input is a lower bound, the max is an upper bound. Leaving one empty will skip that bound (e.g., leaving the min bound input empty will filter only on the max bound -- filtering on \&quot;less than or equal\&quot;). Leading 0 required.
func (r ApiFindingsListRequest) EpssScoreMin(epssScoreMin float64) ApiFindingsListRequest {
	r.epssScoreMin = &epssScoreMin
	return r
}
...
func (r ApiFindingsListRequest) FixAvailable(fixAvailable bool) ApiFindingsListRequest {
	r.fixAvailable = &fixAvailable
	return r
}
...
func (r ApiFindingsListRequest) KevDate(kevDate string) ApiFindingsListRequest {
	r.kevDate = &kevDate
	return r
}

func (r ApiFindingsListRequest) KnownExploited(knownExploited bool) ApiFindingsListRequest {
	r.knownExploited = &knownExploited
	return r
}
...
// Mitigated After
func (r ApiFindingsListRequest) MitigatedAfter(mitigatedAfter time.Time) ApiFindingsListRequest {
	r.mitigatedAfter = &mitigatedAfter
	return r
}

func (r ApiFindingsListRequest) MitigatedBefore(mitigatedBefore time.Time) ApiFindingsListRequest {
	r.mitigatedBefore = &mitigatedBefore
	return r
}
...
func (r ApiFindingsListRequest) MitigatedOn(mitigatedOn time.Time) ApiFindingsListRequest {
	r.mitigatedOn = &mitigatedOn
	return r
}
...
func (r ApiFindingsListRequest) RansomwareUsed(ransomwareUsed bool) ApiFindingsListRequest {
	r.ransomwareUsed = &ransomwareUsed
	return r
}
...
// Comma separated list of exact tags to match with an AND expression
func (r ApiFindingsListRequest) TagsAnd(tagsAnd []string) ApiFindingsListRequest {
	r.tagsAnd = &tagsAnd
	return r
}
...
// Comma separated list of exact tags to match with an AND expression present on product
func (r ApiFindingsListRequest) TestEngagementProductTagsAnd(testEngagementProductTagsAnd []string) ApiFindingsListRequest {
	r.testEngagementProductTagsAnd = &testEngagementProductTagsAnd
	return r
}
...
// Comma separated list of exact tags to match with an AND expression present on engagement
func (r ApiFindingsListRequest) TestEngagementTagsAnd(testEngagementTagsAnd []string) ApiFindingsListRequest {
	r.testEngagementTagsAnd = &testEngagementTagsAnd
	return r
}
...
// Comma separated list of exact tags to match with an AND expression present on test
func (r ApiFindingsListRequest) TestTagsAnd(testTagsAnd []string) ApiFindingsListRequest {
	r.testTagsAnd = &testTagsAnd
	return r
}
...
func (a *FindingsAPIService) FindingsListExecute(r ApiFindingsListRequest) (*PaginatedFindingList, *http.Response, error) {
	...
	if r.relatedFields != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "related_fields", r.relatedFields, "")
	}
	if r.reporter != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "reporter", r.reporter, "csv")
	}
