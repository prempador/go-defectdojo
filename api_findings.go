...
func (r ApiFindingsAcceptRisksCreateRequest) After(after string) ApiFindingsAcceptRisksCreateRequest {
	r.after = &after
	return r
}

func (r ApiFindingsAcceptRisksCreateRequest) Before(before string) ApiFindingsAcceptRisksCreateRequest {
	r.before = &before
	return r
}
...
func (r ApiFindingsAcceptRisksCreateRequest) On(on string) ApiFindingsAcceptRisksCreateRequest {
	r.on = &on
	return r
}
...
func (a *FindingsAPIService) FindingsAcceptRisksCreateExecute(r ApiFindingsAcceptRisksCreateRequest) (*PaginatedRiskAcceptanceList, *http.Response, error) {
	...
	if r.epssPercentile != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "epss_percentile", r.epssPercentile, "")
	}
	if r.epssScore != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "epss_score", r.epssScore, "")
	}
	if r.falseP != nil {
...
func (r ApiFindingsListRequest) After(after string) ApiFindingsListRequest {
	r.after = &after
	return r
}

func (r ApiFindingsListRequest) Before(before string) ApiFindingsListRequest {
	r.before = &before
	return r
}
...
func (r ApiFindingsListRequest) On(on string) ApiFindingsListRequest {
	r.on = &on
	return r
}
