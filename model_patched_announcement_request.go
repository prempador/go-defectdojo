...
// checks if the PatchedAnnouncementRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedAnnouncementRequest{}

// PatchedAnnouncementRequest struct for PatchedAnnouncementRequest
type PatchedAnnouncementRequest struct {
...
type _PatchedAnnouncementRequest PatchedAnnouncementRequest
...
func NewPatchedAnnouncementRequest() *PatchedAnnouncementRequest {
	this := PatchedAnnouncementRequest{}
	return &this
}
...
func (o PatchedAnnouncementRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedAnnouncementRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedAnnouncementRequest) UnmarshalJSON(data []byte) (err error) {
	varPatchedAnnouncementRequest := _PatchedAnnouncementRequest{}

	err = json.Unmarshal(data, &varPatchedAnnouncementRequest)

	if err != nil {
		return err
	}

	*o = PatchedAnnouncementRequest(varPatchedAnnouncementRequest)
...
type NullablePatchedAnnouncementRequest struct {
	value *PatchedAnnouncementRequest
	isSet bool
}

func (v NullablePatchedAnnouncementRequest) Get() *PatchedAnnouncementRequest {
	return v.value
}

func (v *NullablePatchedAnnouncementRequest) Set(val *PatchedAnnouncementRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedAnnouncementRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedAnnouncementRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedAnnouncementRequest(val *PatchedAnnouncementRequest) *NullablePatchedAnnouncementRequest {
	return &NullablePatchedAnnouncementRequest{value: val, isSet: true}
}

func (v NullablePatchedAnnouncementRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedAnnouncementRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
