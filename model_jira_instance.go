...
// checks if the JIRAInstance type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JIRAInstance{}

// JIRAInstance struct for JIRAInstance
type JIRAInstance struct {
	...
	Url string `json:"url"`
	// Username or Email Address, see DefectDojo documentation for more information.
	...
	// JIRA issues that are closed in JIRA with one of these resolutions will result in the Finding being marked as False Positive Defect Dojo. This mapping is not used when Findings are pushed to JIRA. In that case the Finding is closed in JIRA and JIRA sets the default resolution.
...
type _JIRAInstance JIRAInstance
...
func (o *JIRAInstance) SetIssueTemplateDirNil() {
...
func (o *JIRAInstance) SetFindingTextNil() {
...
func (o *JIRAInstance) SetAcceptedMappingResolutionNil() {
...
func (o *JIRAInstance) SetFalsePositiveMappingResolutionNil() {
...
func (o JIRAInstance) MarshalJSON() ([]byte, error) {
...
func (o JIRAInstance) ToMap() (map[string]interface{}, error) {
...
func (o *JIRAInstance) UnmarshalJSON(data []byte) (err error) {
	...
	varJIRAInstance := _JIRAInstance{}

	err = json.Unmarshal(data, &varJIRAInstance)

	if err != nil {
		return err
	}

	*o = JIRAInstance(varJIRAInstance)
...
type NullableJIRAInstance struct {
	value *JIRAInstance
	isSet bool
}

func (v NullableJIRAInstance) Get() *JIRAInstance {
	return v.value
}

func (v *NullableJIRAInstance) Set(val *JIRAInstance) {
	v.value = val
	v.isSet = true
}

func (v NullableJIRAInstance) IsSet() bool {
	return v.isSet
}

func (v *NullableJIRAInstance) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJIRAInstance(val *JIRAInstance) *NullableJIRAInstance {
	return &NullableJIRAInstance{value: val, isSet: true}
}

func (v NullableJIRAInstance) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJIRAInstance) UnmarshalJSON(src []byte) error {
	v.isSet = true
