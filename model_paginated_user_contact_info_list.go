...
type PaginatedUserContactInfoList struct {
	...
	Results []UserContactInfo `json:"results"`
	Prefetch *PaginatedUserContactInfoListPrefetch `json:"prefetch,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _PaginatedUserContactInfoList PaginatedUserContactInfoList
...
func (o *PaginatedUserContactInfoList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedUserContactInfoList := _PaginatedUserContactInfoList{}

	err = json.Unmarshal(data, &varPaginatedUserContactInfoList)

	if err != nil {
		return err
	}

	*o = PaginatedUserContactInfoList(varPaginatedUserContactInfoList)
