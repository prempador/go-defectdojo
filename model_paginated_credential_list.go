...
type _PaginatedCredentialList PaginatedCredentialList
...
func (o *PaginatedCredentialList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedCredentialList := _PaginatedCredentialList{}

	err = json.Unmarshal(data, &varPaginatedCredentialList)

	if err != nil {
		return err
	}

	*o = PaginatedCredentialList(varPaginatedCredentialList)
