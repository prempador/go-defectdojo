...
// checks if the PaginatedToolConfigurationList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedToolConfigurationList{}

// PaginatedToolConfigurationList struct for PaginatedToolConfigurationList
type PaginatedToolConfigurationList struct {
	Count int32 `json:"count"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results []ToolConfiguration `json:"results"`
	Prefetch *PaginatedToolConfigurationListPrefetch `json:"prefetch,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _PaginatedToolConfigurationList PaginatedToolConfigurationList
...
func NewPaginatedToolConfigurationList(count int32, results []ToolConfiguration) *PaginatedToolConfigurationList {
	this := PaginatedToolConfigurationList{}
	this.Count = count
...
func (o *PaginatedToolConfigurationList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedToolConfigurationList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o *PaginatedToolConfigurationList) GetPrefetch() PaginatedToolConfigurationListPrefetch {
	if o == nil || IsNil(o.Prefetch) {
		var ret PaginatedToolConfigurationListPrefetch
		return ret
	}
	return *o.Prefetch
}
...
// SetPrefetch gets a reference to the given PaginatedToolConfigurationListPrefetch and assigns it to the Prefetch field.
func (o *PaginatedToolConfigurationList) SetPrefetch(v PaginatedToolConfigurationListPrefetch) {
	o.Prefetch = &v
}

func (o PaginatedToolConfigurationList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedToolConfigurationList) ToMap() (map[string]interface{}, error) {
...
func (o *PaginatedToolConfigurationList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedToolConfigurationList := _PaginatedToolConfigurationList{}

	err = json.Unmarshal(data, &varPaginatedToolConfigurationList)

	if err != nil {
		return err
	}

	*o = PaginatedToolConfigurationList(varPaginatedToolConfigurationList)
...
type NullablePaginatedToolConfigurationList struct {
	value *PaginatedToolConfigurationList
	isSet bool
}

func (v NullablePaginatedToolConfigurationList) Get() *PaginatedToolConfigurationList {
	return v.value
}

func (v *NullablePaginatedToolConfigurationList) Set(val *PaginatedToolConfigurationList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedToolConfigurationList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedToolConfigurationList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedToolConfigurationList(val *PaginatedToolConfigurationList) *NullablePaginatedToolConfigurationList {
	return &NullablePaginatedToolConfigurationList{value: val, isSet: true}
}

func (v NullablePaginatedToolConfigurationList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedToolConfigurationList) UnmarshalJSON(src []byte) error {
	v.isSet = true
