...
type MetadataAPI interface {
	...
	/*
	MetadataBatchCreate Method for MetadataBatchCreate

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiMetadataBatchCreateRequest
	*/
	MetadataBatchCreate(ctx context.Context) ApiMetadataBatchCreateRequest

	// MetadataBatchCreateExecute executes the request
	//  @return MetaMain
	MetadataBatchCreateExecute(r ApiMetadataBatchCreateRequest) (*MetaMain, *http.Response, error)

	/*
	MetadataBatchPartialUpdate Method for MetadataBatchPartialUpdate

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiMetadataBatchPartialUpdateRequest
	*/
	MetadataBatchPartialUpdate(ctx context.Context) ApiMetadataBatchPartialUpdateRequest

	// MetadataBatchPartialUpdateExecute executes the request
	//  @return MetaMain
	MetadataBatchPartialUpdateExecute(r ApiMetadataBatchPartialUpdateRequest) (*MetaMain, *http.Response, error)
...
type ApiMetadataBatchCreateRequest struct {
	ctx context.Context
	ApiService MetadataAPI
	metaMainRequest *MetaMainRequest
}

func (r ApiMetadataBatchCreateRequest) MetaMainRequest(metaMainRequest MetaMainRequest) ApiMetadataBatchCreateRequest {
	r.metaMainRequest = &metaMainRequest
	return r
}

func (r ApiMetadataBatchCreateRequest) Execute() (*MetaMain, *http.Response, error) {
	return r.ApiService.MetadataBatchCreateExecute(r)
}
...
MetadataBatchCreate Method for MetadataBatchCreate
 ...
 @return ApiMetadataBatchCreateRequest
*/
func (a *MetadataAPIService) MetadataBatchCreate(ctx context.Context) ApiMetadataBatchCreateRequest {
	return ApiMetadataBatchCreateRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return MetaMain
func (a *MetadataAPIService) MetadataBatchCreateExecute(r ApiMetadataBatchCreateRequest) (*MetaMain, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MetaMain
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MetadataAPIService.MetadataBatchCreate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/metadata/batch/"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.metaMainRequest == nil {
		return localVarReturnValue, nil, reportError("metaMainRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.metaMainRequest
	if r.ctx != nil {
...
type ApiMetadataBatchPartialUpdateRequest struct {
	ctx context.Context
	ApiService MetadataAPI
	patchedMetaMainRequest *PatchedMetaMainRequest
}

func (r ApiMetadataBatchPartialUpdateRequest) PatchedMetaMainRequest(patchedMetaMainRequest PatchedMetaMainRequest) ApiMetadataBatchPartialUpdateRequest {
	r.patchedMetaMainRequest = &patchedMetaMainRequest
	return r
}

func (r ApiMetadataBatchPartialUpdateRequest) Execute() (*MetaMain, *http.Response, error) {
	return r.ApiService.MetadataBatchPartialUpdateExecute(r)
}
...
MetadataBatchPartialUpdate Method for MetadataBatchPartialUpdate
 ...
 @return ApiMetadataBatchPartialUpdateRequest
*/
func (a *MetadataAPIService) MetadataBatchPartialUpdate(ctx context.Context) ApiMetadataBatchPartialUpdateRequest {
	return ApiMetadataBatchPartialUpdateRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return MetaMain
func (a *MetadataAPIService) MetadataBatchPartialUpdateExecute(r ApiMetadataBatchPartialUpdateRequest) (*MetaMain, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MetadataAPIService.MetadataBatchPartialUpdate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	// body params
	localVarPostBody = r.patchedMetaMainRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["tokenAuth"]; ok {
...
func (r ApiMetadataListRequest) NameCaseInsensitive(nameCaseInsensitive string) ApiMetadataListRequest {
	r.nameCaseInsensitive = &nameCaseInsensitive
	return r
}
...
func (r ApiMetadataListRequest) ValueCaseInsensitive(valueCaseInsensitive string) ApiMetadataListRequest {
	r.valueCaseInsensitive = &valueCaseInsensitive
	return r
}
...
func (a *MetadataAPIService) MetadataListExecute(r ApiMetadataListRequest) (*PaginatedMetaList, *http.Response, error) {
	...
	if r.nameCaseInsensitive != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "name_case_insensitive", r.nameCaseInsensitive, "")
	}
	if r.offset != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "offset", r.offset, "")
	}
	...
	if r.valueCaseInsensitive != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "value_case_insensitive", r.valueCaseInsensitive, "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
