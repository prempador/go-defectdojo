...
type PatchedFindingRequest struct {
	...
	// Whether this vulnerability is known to have been exploited in the wild.
	KnownExploited *bool `json:"known_exploited,omitempty"`
	// Whether this vulnerability is known to have been leveraged as part of a ransomware campaign.
	RansomwareUsed *bool `json:"ransomware_used,omitempty"`
	// The date the vulnerability was added to the KEV catalog.
	KevDate NullableString `json:"kev_date,omitempty"`
	// Common Vulnerability Scoring System version 3 (CVSS3) score associated with this finding.
	...
	Cvssv4 NullableString `json:"cvssv4,omitempty"`
	// Numerical CVSSv4 score for the vulnerability. If the vector is given, the score is updated while saving the finding. The value must be between 0-10.
	Cvssv4Score NullableFloat64 `json:"cvssv4_score,omitempty"`
	...
	// Denotes if there is a fix available for this flaw.
	FixAvailable NullableBool `json:"fix_available,omitempty"`
	...
	// Vulnerability technical id from the source tool. Allows to track unique vulnerabilities over time across subsequent scans.
...
type _PatchedFindingRequest PatchedFindingRequest
...
// GetKnownExploited returns the KnownExploited field value if set, zero value otherwise.
func (o *PatchedFindingRequest) GetKnownExploited() bool {
	if o == nil || IsNil(o.KnownExploited) {
		var ret bool
		return ret
	}
	return *o.KnownExploited
}

// GetKnownExploitedOk returns a tuple with the KnownExploited field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PatchedFindingRequest) GetKnownExploitedOk() (*bool, bool) {
	if o == nil || IsNil(o.KnownExploited) {
		return nil, false
	}
	return o.KnownExploited, true
}
...
// SetKnownExploited gets a reference to the given bool and assigns it to the KnownExploited field.
func (o *PatchedFindingRequest) SetKnownExploited(v bool) {
	o.KnownExploited = &v
}

// GetRansomwareUsed returns the RansomwareUsed field value if set, zero value otherwise.
func (o *PatchedFindingRequest) GetRansomwareUsed() bool {
	if o == nil || IsNil(o.RansomwareUsed) {
		var ret bool
		return ret
	}
	return *o.RansomwareUsed
}

// GetRansomwareUsedOk returns a tuple with the RansomwareUsed field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PatchedFindingRequest) GetRansomwareUsedOk() (*bool, bool) {
	if o == nil || IsNil(o.RansomwareUsed) {
		return nil, false
	}
	return o.RansomwareUsed, true
}
...
// SetRansomwareUsed gets a reference to the given bool and assigns it to the RansomwareUsed field.
func (o *PatchedFindingRequest) SetRansomwareUsed(v bool) {
	o.RansomwareUsed = &v
}

// GetKevDate returns the KevDate field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *PatchedFindingRequest) GetKevDate() string {
	if o == nil || IsNil(o.KevDate.Get()) {
		var ret string
		return ret
	}
	return *o.KevDate.Get()
}

// GetKevDateOk returns a tuple with the KevDate field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetKevDate gets a reference to the given NullableString and assigns it to the KevDate field.
func (o *PatchedFindingRequest) SetKevDate(v string) {
	o.KevDate.Set(&v)
}
// SetKevDateNil sets the value for KevDate to be an explicit nil
func (o *PatchedFindingRequest) SetKevDateNil() {
	o.KevDate.Set(nil)
}
...
// GetCvssv4 returns the Cvssv4 field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *PatchedFindingRequest) GetCvssv4() string {
	if o == nil || IsNil(o.Cvssv4.Get()) {
		var ret string
		return ret
	}
	return *o.Cvssv4.Get()
...
// GetCvssv4Ok returns a tuple with the Cvssv4 field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetCvssv4 gets a reference to the given NullableString and assigns it to the Cvssv4 field.
func (o *PatchedFindingRequest) SetCvssv4(v string) {
	o.Cvssv4.Set(&v)
}
// SetCvssv4Nil sets the value for Cvssv4 to be an explicit nil
func (o *PatchedFindingRequest) SetCvssv4Nil() {
	o.Cvssv4.Set(nil)
}
...
// GetCvssv4Score returns the Cvssv4Score field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *PatchedFindingRequest) GetCvssv4Score() float64 {
	if o == nil || IsNil(o.Cvssv4Score.Get()) {
		var ret float64
		return ret
	}
	return *o.Cvssv4Score.Get()
}
...
// SetCvssv4Score gets a reference to the given NullableFloat64 and assigns it to the Cvssv4Score field.
...
func (o *PatchedFindingRequest) SetCvssv4ScoreNil() {
...
// GetFixAvailable returns the FixAvailable field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *PatchedFindingRequest) GetFixAvailable() bool {
	if o == nil || IsNil(o.FixAvailable.Get()) {
		var ret bool
		return ret
	}
	return *o.FixAvailable.Get()
}

// GetFixAvailableOk returns a tuple with the FixAvailable field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetFixAvailable gets a reference to the given NullableBool and assigns it to the FixAvailable field.
...
func (o *PatchedFindingRequest) SetFixAvailableNil() {
...
func (o PatchedFindingRequest) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.KnownExploited) {
		toSerialize["known_exploited"] = o.KnownExploited
	}
	if !IsNil(o.RansomwareUsed) {
		toSerialize["ransomware_used"] = o.RansomwareUsed
	}
	if o.KevDate.IsSet() {
		toSerialize["kev_date"] = o.KevDate.Get()
	}
	if o.Cvssv3.IsSet() {
	...
	if o.Cvssv4.IsSet() {
		toSerialize["cvssv4"] = o.Cvssv4.Get()
	}
	if o.Cvssv4Score.IsSet() {
		toSerialize["cvssv4_score"] = o.Cvssv4Score.Get()
	}
	if !IsNil(o.Severity) {
	...
	if o.FixAvailable.IsSet() {
		toSerialize["fix_available"] = o.FixAvailable.Get()
	}
	if o.Impact.IsSet() {
...
func (o *PatchedFindingRequest) UnmarshalJSON(data []byte) (err error) {
	varPatchedFindingRequest := _PatchedFindingRequest{}

	err = json.Unmarshal(data, &varPatchedFindingRequest)

	if err != nil {
		return err
	}

	*o = PatchedFindingRequest(varPatchedFindingRequest)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "known_exploited")
		delete(additionalProperties, "ransomware_used")
		delete(additionalProperties, "kev_date")
		delete(additionalProperties, "cvssv3")
		delete(additionalProperties, "cvssv3_score")
		delete(additionalProperties, "cvssv4")
		delete(additionalProperties, "cvssv4_score")
		delete(additionalProperties, "severity")
		delete(additionalProperties, "description")
		delete(additionalProperties, "mitigation")
		delete(additionalProperties, "fix_available")
