...
type _ReportGenerateOptionRequest ReportGenerateOptionRequest
...
func (o *ReportGenerateOptionRequest) UnmarshalJSON(data []byte) (err error) {
	varReportGenerateOptionRequest := _ReportGenerateOptionRequest{}

	err = json.Unmarshal(data, &varReportGenerateOptionRequest)

	if err != nil {
		return err
	}

	*o = ReportGenerateOptionRequest(varReportGenerateOptionRequest)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "include_finding_notes")
		delete(additionalProperties, "include_finding_images")
		delete(additionalProperties, "include_executive_summary")
		delete(additionalProperties, "include_table_of_contents")
