...
// checks if the PatchedGlobalRoleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedGlobalRoleRequest{}

// PatchedGlobalRoleRequest struct for PatchedGlobalRoleRequest
...
type _PatchedGlobalRoleRequest PatchedGlobalRoleRequest
...
func (o *PatchedGlobalRoleRequest) SetUserNil() {
	o.User.Set(nil)
}
...
func (o *PatchedGlobalRoleRequest) SetGroupNil() {
	o.Group.Set(nil)
}
...
func (o *PatchedGlobalRoleRequest) SetRoleNil() {
	o.Role.Set(nil)
}
...
func (o PatchedGlobalRoleRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedGlobalRoleRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedGlobalRoleRequest) UnmarshalJSON(data []byte) (err error) {
	varPatchedGlobalRoleRequest := _PatchedGlobalRoleRequest{}

	err = json.Unmarshal(data, &varPatchedGlobalRoleRequest)

	if err != nil {
		return err
	}

	*o = PatchedGlobalRoleRequest(varPatchedGlobalRoleRequest)
...
type NullablePatchedGlobalRoleRequest struct {
	value *PatchedGlobalRoleRequest
	isSet bool
}

func (v NullablePatchedGlobalRoleRequest) Get() *PatchedGlobalRoleRequest {
	return v.value
}

func (v *NullablePatchedGlobalRoleRequest) Set(val *PatchedGlobalRoleRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedGlobalRoleRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedGlobalRoleRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedGlobalRoleRequest(val *PatchedGlobalRoleRequest) *NullablePatchedGlobalRoleRequest {
	return &NullablePatchedGlobalRoleRequest{value: val, isSet: true}
}

func (v NullablePatchedGlobalRoleRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedGlobalRoleRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
