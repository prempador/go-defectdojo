...
func (a *EngagementsAPIService) EngagementsListExecute(r ApiEngagementsListRequest) (*PaginatedEngagementList, *http.Response, error) {
	...
	if r.apiTest != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "api_test", r.apiTest, "form", "")
	}
	if r.hasTags != nil {
	...
	if r.notProductTags != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "not_product__tags", r.notProductTags, "form", "csv")
	}
	if r.notTag != nil {
	...
	if r.penTest != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "pen_test", r.penTest, "form", "")
	}
	if r.product != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "product", r.product, "form", "")
	}
	if r.productProdType != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "product__prod_type", r.productProdType, "form", "csv")
	}
	if r.productTags != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "product__tags", r.productTags, "form", "csv")
	}
	if r.reportType != nil {
	...
	if r.threatModel != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "threat_model", r.threatModel, "form", "")
	}
	if r.updated != nil {
