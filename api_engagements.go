...
type EngagementsAPI interface {
	...
	*/
	...
	/*
	EngagementsUpdateJiraEpicCreate Method for EngagementsUpdateJiraEpicCreate

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id A unique integer value identifying this engagement.
	@return ApiEngagementsUpdateJiraEpicCreateRequest
	*/
	EngagementsUpdateJiraEpicCreate(ctx context.Context, id int32) ApiEngagementsUpdateJiraEpicCreateRequest

	// EngagementsUpdateJiraEpicCreateExecute executes the request
	//  @return EngagementUpdateJiraEpic
	EngagementsUpdateJiraEpicCreateExecute(r ApiEngagementsUpdateJiraEpicCreateRequest) (*EngagementUpdateJiraEpic, *http.Response, error)
}
...
func (r ApiEngagementsListRequest) ProductTagsAnd(productTagsAnd []string) ApiEngagementsListRequest {
	r.productTagsAnd = &productTagsAnd
	return r
}
...
func (r ApiEngagementsListRequest) TagsAnd(tagsAnd []string) ApiEngagementsListRequest {
	r.tagsAnd = &tagsAnd
	return r
}
...
func (a *EngagementsAPIService) EngagementsListExecute(r ApiEngagementsListRequest) (*PaginatedEngagementList, *http.Response, error) {
	...
	if r.productTagsAnd != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "product__tags__and", r.productTagsAnd, "csv")
	}
	if r.reportType != nil {
...
type ApiEngagementsUpdateJiraEpicCreateRequest struct {
	ctx context.Context
	ApiService EngagementsAPI
	id int32
	engagementUpdateJiraEpicRequest *EngagementUpdateJiraEpicRequest
}

func (r ApiEngagementsUpdateJiraEpicCreateRequest) EngagementUpdateJiraEpicRequest(engagementUpdateJiraEpicRequest EngagementUpdateJiraEpicRequest) ApiEngagementsUpdateJiraEpicCreateRequest {
	r.engagementUpdateJiraEpicRequest = &engagementUpdateJiraEpicRequest
	return r
}

func (r ApiEngagementsUpdateJiraEpicCreateRequest) Execute() (*EngagementUpdateJiraEpic, *http.Response, error) {
	return r.ApiService.EngagementsUpdateJiraEpicCreateExecute(r)
}
...
EngagementsUpdateJiraEpicCreate Method for EngagementsUpdateJiraEpicCreate
 ...
 @return ApiEngagementsUpdateJiraEpicCreateRequest
*/
func (a *EngagementsAPIService) EngagementsUpdateJiraEpicCreate(ctx context.Context, id int32) ApiEngagementsUpdateJiraEpicCreateRequest {
	return ApiEngagementsUpdateJiraEpicCreateRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return EngagementUpdateJiraEpic
func (a *EngagementsAPIService) EngagementsUpdateJiraEpicCreateExecute(r ApiEngagementsUpdateJiraEpicCreateRequest) (*EngagementUpdateJiraEpic, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *EngagementUpdateJiraEpic
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EngagementsAPIService.EngagementsUpdateJiraEpicCreate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/engagements/{id}/update_jira_epic/"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
	...
	// body params
	localVarPostBody = r.engagementUpdateJiraEpicRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["tokenAuth"]; ok {
