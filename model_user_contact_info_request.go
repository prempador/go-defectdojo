...
type UserContactInfoRequest struct {
	...
	PhoneNumber *string `json:"phone_number,omitempty" validate:"regexp=^\\\\+?1?\\\\d{9,15}$"`
	// Phone number must be entered in the format: '+999999999'. Up to 15 digits allowed.
	CellNumber *string `json:"cell_number,omitempty" validate:"regexp=^\\\\+?1?\\\\d{9,15}$"`
...
func (o *UserContactInfoRequest) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varUserContactInfoRequest)
	...
	*o = UserContactInfoRequest(varUserContactInfoRequest)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "cell_number")
		delete(additionalProperties, "twitter_username")
		delete(additionalProperties, "github_username")
		delete(additionalProperties, "slack_username")
		delete(additionalProperties, "slack_user_id")
		delete(additionalProperties, "block_execution")
		delete(additionalProperties, "force_password_reset")
