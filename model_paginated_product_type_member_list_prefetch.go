...
type _PaginatedProductTypeMemberListPrefetch PaginatedProductTypeMemberListPrefetch
...
func (o *PaginatedProductTypeMemberListPrefetch) UnmarshalJSON(data []byte) (err error) {
	varPaginatedProductTypeMemberListPrefetch := _PaginatedProductTypeMemberListPrefetch{}

	err = json.Unmarshal(data, &varPaginatedProductTypeMemberListPrefetch)

	if err != nil {
		return err
	}

	*o = PaginatedProductTypeMemberListPrefetch(varPaginatedProductTypeMemberListPrefetch)
