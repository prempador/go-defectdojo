...
type _PatchedToolProductSettingsRequest PatchedToolProductSettingsRequest
...
func (o *PatchedToolProductSettingsRequest) UnmarshalJSON(data []byte) (err error) {
	varPatchedToolProductSettingsRequest := _PatchedToolProductSettingsRequest{}

	err = json.Unmarshal(data, &varPatchedToolProductSettingsRequest)

	if err != nil {
		return err
	}

	*o = PatchedToolProductSettingsRequest(varPatchedToolProductSettingsRequest)
