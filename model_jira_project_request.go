...
type _JIRAProjectRequest JIRAProjectRequest
...
func (o *JIRAProjectRequest) UnmarshalJSON(data []byte) (err error) {
	varJIRAProjectRequest := _JIRAProjectRequest{}

	err = json.Unmarshal(data, &varJIRAProjectRequest)

	if err != nil {
		return err
	}

	*o = JIRAProjectRequest(varJIRAProjectRequest)
