...
type _FindingClose FindingClose
...
func (o *FindingClose) UnmarshalJSON(data []byte) (err error) {
	varFindingClose := _FindingClose{}

	err = json.Unmarshal(data, &varFindingClose)

	if err != nil {
		return err
	}

	*o = FindingClose(varFindingClose)
