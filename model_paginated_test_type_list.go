...
type PaginatedTestTypeList struct {
	...
	Results []TestType `json:"results"`
	AdditionalProperties map[string]interface{}
}

type _PaginatedTestTypeList PaginatedTestTypeList
...
func (o *PaginatedTestTypeList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedTestTypeList := _PaginatedTestTypeList{}

	err = json.Unmarshal(data, &varPaginatedTestTypeList)

	if err != nil {
		return err
	}

	*o = PaginatedTestTypeList(varPaginatedTestTypeList)
