...
// checks if the PaginatedFindingList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedFindingList{}

// PaginatedFindingList struct for PaginatedFindingList
...
type _PaginatedFindingList PaginatedFindingList
...
func (o *PaginatedFindingList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedFindingList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o PaginatedFindingList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedFindingList) ToMap() (map[string]interface{}, error) {
...
func (o *PaginatedFindingList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedFindingList := _PaginatedFindingList{}

	err = json.Unmarshal(data, &varPaginatedFindingList)

	if err != nil {
		return err
	}

	*o = PaginatedFindingList(varPaginatedFindingList)
...
type NullablePaginatedFindingList struct {
	value *PaginatedFindingList
	isSet bool
}

func (v NullablePaginatedFindingList) Get() *PaginatedFindingList {
	return v.value
}

func (v *NullablePaginatedFindingList) Set(val *PaginatedFindingList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedFindingList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedFindingList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedFindingList(val *PaginatedFindingList) *NullablePaginatedFindingList {
	return &NullablePaginatedFindingList{value: val, isSet: true}
}

func (v NullablePaginatedFindingList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedFindingList) UnmarshalJSON(src []byte) error {
	v.isSet = true
