...
type _PatchedFindingTemplateRequest PatchedFindingTemplateRequest
...
func (o *PatchedFindingTemplateRequest) UnmarshalJSON(data []byte) (err error) {
	varPatchedFindingTemplateRequest := _PatchedFindingTemplateRequest{}

	err = json.Unmarshal(data, &varPatchedFindingTemplateRequest)

	if err != nil {
		return err
	}

	*o = PatchedFindingTemplateRequest(varPatchedFindingTemplateRequest)
