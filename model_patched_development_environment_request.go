...
type _PatchedDevelopmentEnvironmentRequest PatchedDevelopmentEnvironmentRequest
...
func (o *PatchedDevelopmentEnvironmentRequest) UnmarshalJSON(data []byte) (err error) {
	varPatchedDevelopmentEnvironmentRequest := _PatchedDevelopmentEnvironmentRequest{}

	err = json.Unmarshal(data, &varPatchedDevelopmentEnvironmentRequest)

	if err != nil {
		return err
	}

	*o = PatchedDevelopmentEnvironmentRequest(varPatchedDevelopmentEnvironmentRequest)
