...
type _NotificationsRequest NotificationsRequest
...
func (o *NotificationsRequest) UnmarshalJSON(data []byte) (err error) {
	varNotificationsRequest := _NotificationsRequest{}

	err = json.Unmarshal(data, &varNotificationsRequest)

	if err != nil {
		return err
	}

	*o = NotificationsRequest(varNotificationsRequest)
