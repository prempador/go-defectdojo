...
// checks if the MetaMain type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetaMain{}

// MetaMain struct for MetaMain
...
func (o *MetaMain) SetEndpointNil() {
	o.Endpoint.Set(nil)
}
...
func (o MetaMain) MarshalJSON() ([]byte, error) {
...
func (o MetaMain) ToMap() (map[string]interface{}, error) {
...
func (o *MetaMain) UnmarshalJSON(data []byte) (err error) {
	...
	varMetaMain := _MetaMain{}

	err = json.Unmarshal(data, &varMetaMain)

	if err != nil {
		return err
	}

	*o = MetaMain(varMetaMain)
...
type NullableMetaMain struct {
	value *MetaMain
	isSet bool
}

func (v NullableMetaMain) Get() *MetaMain {
	return v.value
}

func (v *NullableMetaMain) Set(val *MetaMain) {
	v.value = val
	v.isSet = true
}

func (v NullableMetaMain) IsSet() bool {
	return v.isSet
}

func (v *NullableMetaMain) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMetaMain(val *MetaMain) *NullableMetaMain {
	return &NullableMetaMain{value: val, isSet: true}
}

func (v NullableMetaMain) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMetaMain) UnmarshalJSON(src []byte) error {
	v.isSet = true
