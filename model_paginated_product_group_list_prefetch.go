...
type _PaginatedProductGroupListPrefetch PaginatedProductGroupListPrefetch
...
func (o *PaginatedProductGroupListPrefetch) UnmarshalJSON(data []byte) (err error) {
	varPaginatedProductGroupListPrefetch := _PaginatedProductGroupListPrefetch{}

	err = json.Unmarshal(data, &varPaginatedProductGroupListPrefetch)

	if err != nil {
		return err
	}

	*o = PaginatedProductGroupListPrefetch(varPaginatedProductGroupListPrefetch)
