...
type PaginatedProductTypeMemberList struct {
	...
	Results []ProductTypeMember `json:"results"`
	Prefetch *PaginatedProductTypeMemberListPrefetch `json:"prefetch,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _PaginatedProductTypeMemberList PaginatedProductTypeMemberList
...
func (o *PaginatedProductTypeMemberList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedProductTypeMemberList := _PaginatedProductTypeMemberList{}

	err = json.Unmarshal(data, &varPaginatedProductTypeMemberList)

	if err != nil {
		return err
	}

	*o = PaginatedProductTypeMemberList(varPaginatedProductTypeMemberList)
