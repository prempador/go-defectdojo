...
type _FindingCloseRequest FindingCloseRequest
...
func (o *FindingCloseRequest) UnmarshalJSON(data []byte) (err error) {
	varFindingCloseRequest := _FindingCloseRequest{}

	err = json.Unmarshal(data, &varFindingCloseRequest)

	if err != nil {
		return err
	}

	*o = FindingCloseRequest(varFindingCloseRequest)
