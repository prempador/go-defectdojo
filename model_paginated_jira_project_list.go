...
type PaginatedJIRAProjectList struct {
	...
	Results []JIRAProject `json:"results"`
	Prefetch *JIRAProjectPrefetch `json:"prefetch,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _PaginatedJIRAProjectList PaginatedJIRAProjectList
...
func (o *PaginatedJIRAProjectList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedJIRAProjectList := _PaginatedJIRAProjectList{}

	err = json.Unmarshal(data, &varPaginatedJIRAProjectList)

	if err != nil {
		return err
	}

	*o = PaginatedJIRAProjectList(varPaginatedJIRAProjectList)
