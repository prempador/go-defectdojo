...
func (r ApiQuestionnaireAnsweredQuestionnairesListRequest) Prefetch(prefetch []string) ApiQuestionnaireAnsweredQuestionnairesListRequest {
	r.prefetch = &prefetch
	return r
}
...
// List of fields for which to prefetch model instances and add those to the response
func (r ApiQuestionnaireAnsweredQuestionnairesRetrieveRequest) Prefetch(prefetch []string) ApiQuestionnaireAnsweredQuestionnairesRetrieveRequest {
	r.prefetch = &prefetch
	return r
}
