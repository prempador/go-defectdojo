...
func (o *Finding) GetSlaDaysRemaining() int32 {
	if o == nil || o.SlaDaysRemaining.Get() == nil {
		var ret int32
		return ret
	}

	return *o.SlaDaysRemaining.Get()
}
...
func (o *Finding) GetSlaDaysRemainingOk() (*int32, bool) {
	...
	return o.SlaDaysRemaining.Get(), o.SlaDaysRemaining.IsSet()
}

// SetSlaDaysRemaining sets field value
func (o *Finding) SetSlaDaysRemaining(v int32) {
	o.SlaDaysRemaining.Set(&v)
}
...
// If the value is explicit nil, the zero value for FindingRelatedFields will be returned
func (o *Finding) GetRelatedFields() FindingRelatedFields {
	if o == nil || o.RelatedFields.Get() == nil {
		var ret FindingRelatedFields
		return ret
	}

	return *o.RelatedFields.Get()
}
...
func (o Finding) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["sla_days_remaining"] = o.SlaDaysRemaining.Get()
	toSerialize["finding_meta"] = o.FindingMeta
	toSerialize["related_fields"] = o.RelatedFields.Get()
...
func (o *Finding) UnmarshalJSON(data []byte) (err error) {
	...
	*o = Finding(varFinding)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "request_response")
		delete(additionalProperties, "accepted_risks")
		delete(additionalProperties, "push_to_jira")
		delete(additionalProperties, "age")
		delete(additionalProperties, "sla_days_remaining")
		delete(additionalProperties, "finding_meta")
		delete(additionalProperties, "related_fields")
		delete(additionalProperties, "jira_creation")
		delete(additionalProperties, "jira_change")
