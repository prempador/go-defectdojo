...
func (a *ProductTypesAPIService) ProductTypesListExecute(r ApiProductTypesListRequest) (*PaginatedProductTypeList, *http.Response, error) {
	...
	if r.criticalProduct != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "critical_product", r.criticalProduct, "form", "")
	}
	if r.id != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "id", r.id, "form", "")
	}
	if r.keyProduct != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "key_product", r.keyProduct, "form", "")
	}
	if r.limit != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "limit", r.limit, "form", "")
	}
