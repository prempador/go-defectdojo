...
type PaginatedProductGroupList struct {
	...
	Results []ProductGroup `json:"results"`
	Prefetch *PaginatedProductGroupListPrefetch `json:"prefetch,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _PaginatedProductGroupList PaginatedProductGroupList
...
func (o *PaginatedProductGroupList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedProductGroupList := _PaginatedProductGroupList{}

	err = json.Unmarshal(data, &varPaginatedProductGroupList)

	if err != nil {
		return err
	}

	*o = PaginatedProductGroupList(varPaginatedProductGroupList)
