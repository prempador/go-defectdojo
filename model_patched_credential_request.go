...
type _PatchedCredentialRequest PatchedCredentialRequest
...
func (o *PatchedCredentialRequest) UnmarshalJSON(data []byte) (err error) {
	varPatchedCredentialRequest := _PatchedCredentialRequest{}

	err = json.Unmarshal(data, &varPatchedCredentialRequest)

	if err != nil {
		return err
	}

	*o = PatchedCredentialRequest(varPatchedCredentialRequest)
