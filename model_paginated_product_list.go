...
// checks if the PaginatedProductList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedProductList{}

// PaginatedProductList struct for PaginatedProductList
...
type _PaginatedProductList PaginatedProductList
...
func (o *PaginatedProductList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedProductList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o PaginatedProductList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedProductList) ToMap() (map[string]interface{}, error) {
...
func (o *PaginatedProductList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedProductList := _PaginatedProductList{}

	err = json.Unmarshal(data, &varPaginatedProductList)

	if err != nil {
		return err
	}

	*o = PaginatedProductList(varPaginatedProductList)
...
type NullablePaginatedProductList struct {
	value *PaginatedProductList
	isSet bool
}

func (v NullablePaginatedProductList) Get() *PaginatedProductList {
	return v.value
}

func (v *NullablePaginatedProductList) Set(val *PaginatedProductList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedProductList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedProductList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedProductList(val *PaginatedProductList) *NullablePaginatedProductList {
	return &NullablePaginatedProductList{value: val, isSet: true}
}

func (v NullablePaginatedProductList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedProductList) UnmarshalJSON(src []byte) error {
	v.isSet = true
