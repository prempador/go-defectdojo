...
func (o *Engagement) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varEngagement)
	...
	*o = Engagement(varEngagement)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "tmodel_path")
		delete(additionalProperties, "done_testing")
		...
		delete(additionalProperties, "risk_acceptance")
