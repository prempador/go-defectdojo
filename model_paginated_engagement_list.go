...
type _PaginatedEngagementList PaginatedEngagementList
...
func (o *PaginatedEngagementList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedEngagementList := _PaginatedEngagementList{}

	err = json.Unmarshal(data, &varPaginatedEngagementList)

	if err != nil {
		return err
	}

	*o = PaginatedEngagementList(varPaginatedEngagementList)
