...
type PatchedProductRequest struct {
	...
	Revenue NullableFloat64 `json:"revenue,omitempty" validate:"regexp=^-?\\\\d{0,13}(?:\\\\.\\\\d{0,2})?$"`
...
type _PatchedProductRequest PatchedProductRequest
...
func (o *PatchedProductRequest) UnmarshalJSON(data []byte) (err error) {
	varPatchedProductRequest := _PatchedProductRequest{}

	err = json.Unmarshal(data, &varPatchedProductRequest)

	if err != nil {
		return err
	}

	*o = PatchedProductRequest(varPatchedProductRequest)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "prod_numeric_grade")
		delete(additionalProperties, "business_criticality")
		delete(additionalProperties, "platform")
		delete(additionalProperties, "lifecycle")
		delete(additionalProperties, "origin")
		delete(additionalProperties, "user_records")
		delete(additionalProperties, "revenue")
		delete(additionalProperties, "external_audience")
		delete(additionalProperties, "internet_accessible")
		delete(additionalProperties, "enable_product_tag_inheritance")
		delete(additionalProperties, "enable_simple_risk_acceptance")
		delete(additionalProperties, "enable_full_risk_acceptance")
		delete(additionalProperties, "disable_sla_breach_notifications")
