...
type _PatchedUserContactInfoRequest PatchedUserContactInfoRequest
...
func (o *PatchedUserContactInfoRequest) UnmarshalJSON(data []byte) (err error) {
	varPatchedUserContactInfoRequest := _PatchedUserContactInfoRequest{}

	err = json.Unmarshal(data, &varPatchedUserContactInfoRequest)

	if err != nil {
		return err
	}

	*o = PatchedUserContactInfoRequest(varPatchedUserContactInfoRequest)
