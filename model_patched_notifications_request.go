...
type PatchedNotificationsRequest struct {
	...
	// Triggered whenever an (re-)import has been done (even if that created/updated/closed no findings).  * `slack` - slack * `msteams` - msteams * `mail` - mail * `webhooks` - webhooks * `alert` - alert
	ScanAddedEmpty *string `json:"scan_added_empty,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _PatchedNotificationsRequest PatchedNotificationsRequest
...
func (o *PatchedNotificationsRequest) UnmarshalJSON(data []byte) (err error) {
	varPatchedNotificationsRequest := _PatchedNotificationsRequest{}

	err = json.Unmarshal(data, &varPatchedNotificationsRequest)

	if err != nil {
		return err
	}

	*o = PatchedNotificationsRequest(varPatchedNotificationsRequest)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "product_type_added")
		delete(additionalProperties, "product_added")
		delete(additionalProperties, "engagement_added")
		delete(additionalProperties, "test_added")
		delete(additionalProperties, "scan_added")
		delete(additionalProperties, "jira_update")
		delete(additionalProperties, "upcoming_engagement")
		delete(additionalProperties, "stale_engagement")
		delete(additionalProperties, "auto_close_engagement")
		delete(additionalProperties, "close_engagement")
		delete(additionalProperties, "user_mentioned")
		delete(additionalProperties, "code_review")
		delete(additionalProperties, "review_requested")
		delete(additionalProperties, "other")
		delete(additionalProperties, "sla_breach")
		delete(additionalProperties, "sla_breach_combined")
		delete(additionalProperties, "risk_acceptance_expiration")
		delete(additionalProperties, "template")
		delete(additionalProperties, "scan_added_empty")
