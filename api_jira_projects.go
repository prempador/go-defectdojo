...
func (r ApiJiraProjectsListRequest) Enabled(enabled bool) ApiJiraProjectsListRequest {
	r.enabled = &enabled
	return r
}
...
func (r ApiJiraProjectsListRequest) Prefetch(prefetch []string) ApiJiraProjectsListRequest {
	r.prefetch = &prefetch
	return r
}
...
// List of fields for which to prefetch model instances and add those to the response
func (r ApiJiraProjectsRetrieveRequest) Prefetch(prefetch []string) ApiJiraProjectsRetrieveRequest {
	r.prefetch = &prefetch
	return r
}
