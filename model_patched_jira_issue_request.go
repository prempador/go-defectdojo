...
type _PatchedJIRAIssueRequest PatchedJIRAIssueRequest
...
func (o *PatchedJIRAIssueRequest) UnmarshalJSON(data []byte) (err error) {
	varPatchedJIRAIssueRequest := _PatchedJIRAIssueRequest{}

	err = json.Unmarshal(data, &varPatchedJIRAIssueRequest)

	if err != nil {
		return err
	}

	*o = PatchedJIRAIssueRequest(varPatchedJIRAIssueRequest)
