...
func (r ApiEngagementPresetsListRequest) Prefetch(prefetch []string) ApiEngagementPresetsListRequest {
	r.prefetch = &prefetch
	return r
}
...
// List of fields for which to prefetch model instances and add those to the response
func (r ApiEngagementPresetsRetrieveRequest) Prefetch(prefetch []string) ApiEngagementPresetsRetrieveRequest {
	r.prefetch = &prefetch
	return r
}
