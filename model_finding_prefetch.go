...
type _FindingPrefetch FindingPrefetch
...
// SetFiles gets a reference to the given map[string]File and assigns it to the Files field.
...
func (o *FindingPrefetch) UnmarshalJSON(data []byte) (err error) {
	varFindingPrefetch := _FindingPrefetch{}

	err = json.Unmarshal(data, &varFindingPrefetch)

	if err != nil {
		return err
	}

	*o = FindingPrefetch(varFindingPrefetch)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "endpoint_set")
		delete(additionalProperties, "endpoints")
		delete(additionalProperties, "files")
		delete(additionalProperties, "finding_group_set")
		...
		delete(additionalProperties, "risk_acceptance_set")
		...
		delete(additionalProperties, "test_import_set")
