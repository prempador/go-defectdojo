...
type PaginatedRiskAcceptanceList struct {
	...
	Results []RiskAcceptance `json:"results"`
	AdditionalProperties map[string]interface{}
}

type _PaginatedRiskAcceptanceList PaginatedRiskAcceptanceList
...
func (o *PaginatedRiskAcceptanceList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedRiskAcceptanceList := _PaginatedRiskAcceptanceList{}

	err = json.Unmarshal(data, &varPaginatedRiskAcceptanceList)

	if err != nil {
		return err
	}

	*o = PaginatedRiskAcceptanceList(varPaginatedRiskAcceptanceList)
