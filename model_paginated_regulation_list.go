...
type PaginatedRegulationList struct {
	...
	Results []Regulation `json:"results"`
	AdditionalProperties map[string]interface{}
}

type _PaginatedRegulationList PaginatedRegulationList
...
func (o *PaginatedRegulationList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedRegulationList := _PaginatedRegulationList{}

	err = json.Unmarshal(data, &varPaginatedRegulationList)

	if err != nil {
		return err
	}

	*o = PaginatedRegulationList(varPaginatedRegulationList)
