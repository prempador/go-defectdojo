...
func (o *ExecutiveSummary) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varExecutiveSummary)
	...
	*o = ExecutiveSummary(varExecutiveSummary)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "engagement_target_start")
		delete(additionalProperties, "engagement_target_end")
		delete(additionalProperties, "test_type_name")
		delete(additionalProperties, "test_target_start")
		delete(additionalProperties, "test_target_end")
		delete(additionalProperties, "test_environment_name")
		delete(additionalProperties, "test_strategy_ref")
		delete(additionalProperties, "total_findings")
