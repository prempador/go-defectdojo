...
func (r ApiCredentialsListRequest) Prefetch(prefetch []string) ApiCredentialsListRequest {
	r.prefetch = &prefetch
	return r
}
...
// List of fields for which to prefetch model instances and add those to the response
func (r ApiCredentialsRetrieveRequest) Prefetch(prefetch []string) ApiCredentialsRetrieveRequest {
	r.prefetch = &prefetch
	return r
}
