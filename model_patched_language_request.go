...
type _PatchedLanguageRequest PatchedLanguageRequest
...
func (o *PatchedLanguageRequest) UnmarshalJSON(data []byte) (err error) {
	varPatchedLanguageRequest := _PatchedLanguageRequest{}

	err = json.Unmarshal(data, &varPatchedLanguageRequest)

	if err != nil {
		return err
	}

	*o = PatchedLanguageRequest(varPatchedLanguageRequest)
