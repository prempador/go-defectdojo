...
type _PatchedMetaRequest PatchedMetaRequest
...
func (o *PatchedMetaRequest) UnmarshalJSON(data []byte) (err error) {
	varPatchedMetaRequest := _PatchedMetaRequest{}

	err = json.Unmarshal(data, &varPatchedMetaRequest)

	if err != nil {
		return err
	}

	*o = PatchedMetaRequest(varPatchedMetaRequest)
