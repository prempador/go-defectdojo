...
type _PatchedProductTypeRequest PatchedProductTypeRequest
...
func (o *PatchedProductTypeRequest) UnmarshalJSON(data []byte) (err error) {
	varPatchedProductTypeRequest := _PatchedProductTypeRequest{}

	err = json.Unmarshal(data, &varPatchedProductTypeRequest)

	if err != nil {
		return err
	}

	*o = PatchedProductTypeRequest(varPatchedProductTypeRequest)
