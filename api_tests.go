...
type ApiTestsListRequest struct {
	...
	engagementProductTagsAnd *[]string
	engagementTags *[]string
	engagementTagsAnd *[]string
	hasTags *bool
	id *int32
	limit *int32
...
func (r ApiTestsListRequest) EngagementProductTagsAnd(engagementProductTagsAnd []string) ApiTestsListRequest {
	r.engagementProductTagsAnd = &engagementProductTagsAnd
	return r
}
...
func (r ApiTestsListRequest) EngagementTagsAnd(engagementTagsAnd []string) ApiTestsListRequest {
	r.engagementTagsAnd = &engagementTagsAnd
	return r
}
...
func (r ApiTestsListRequest) TagsAnd(tagsAnd []string) ApiTestsListRequest {
	r.tagsAnd = &tagsAnd
	return r
}
...
func (a *TestsAPIService) TestsListExecute(r ApiTestsListRequest) (*PaginatedTestList, *http.Response, error) {
	...
	if r.engagementProductTagsAnd != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "engagement__product__tags__and", r.engagementProductTagsAnd, "csv")
	}
	if r.engagementTags != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "engagement__tags", r.engagementTags, "csv")
	}
	if r.engagementTagsAnd != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "engagement__tags__and", r.engagementTagsAnd, "csv")
	}
	if r.hasTags != nil {
