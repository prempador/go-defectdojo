...
func (a *TestsAPIService) TestsListExecute(r ApiTestsListRequest) (*PaginatedTestList, *http.Response, error) {
	...
	if r.actualTime != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "actual_time", r.actualTime, "form", "")
	}
	if r.apiScanConfiguration != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "api_scan_configuration", r.apiScanConfiguration, "form", "")
	}
	if r.branchTag != nil {
	...
	if r.engagementProductTags != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "engagement__product__tags", r.engagementProductTags, "form", "csv")
	}
	if r.engagementTags != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "engagement__tags", r.engagementTags, "form", "csv")
	}
	if r.hasTags != nil {
	...
	if r.notEngagementProductTags != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "not_engagement__product__tags", r.notEngagementProductTags, "form", "csv")
	}
	if r.notEngagementTags != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "not_engagement__tags", r.notEngagementTags, "form", "csv")
	}
	if r.notTag != nil {
	...
	if r.percentComplete != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "percent_complete", r.percentComplete, "form", "")
	}
	if r.scanType != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "scan_type", r.scanType, "form", "")
	}
	if r.tag != nil {
	...
	if r.targetEnd != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "target_end", r.targetEnd, "form", "")
	}
	if r.targetStart != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "target_start", r.targetStart, "form", "")
	}
	if r.testType != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "test_type", r.testType, "form", "")
	}
	if r.title != nil {
