...
// checks if the PaginatedToolProductSettingsList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedToolProductSettingsList{}

// PaginatedToolProductSettingsList struct for PaginatedToolProductSettingsList
type PaginatedToolProductSettingsList struct {
	Count int32 `json:"count"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results []ToolProductSettings `json:"results"`
	Prefetch *PaginatedToolProductSettingsListPrefetch `json:"prefetch,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _PaginatedToolProductSettingsList PaginatedToolProductSettingsList
...
func NewPaginatedToolProductSettingsList(count int32, results []ToolProductSettings) *PaginatedToolProductSettingsList {
	this := PaginatedToolProductSettingsList{}
	this.Count = count
...
func (o *PaginatedToolProductSettingsList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedToolProductSettingsList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o PaginatedToolProductSettingsList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedToolProductSettingsList) ToMap() (map[string]interface{}, error) {
...
func (o *PaginatedToolProductSettingsList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedToolProductSettingsList := _PaginatedToolProductSettingsList{}

	err = json.Unmarshal(data, &varPaginatedToolProductSettingsList)

	if err != nil {
		return err
	}

	*o = PaginatedToolProductSettingsList(varPaginatedToolProductSettingsList)
...
type NullablePaginatedToolProductSettingsList struct {
	value *PaginatedToolProductSettingsList
	isSet bool
}

func (v NullablePaginatedToolProductSettingsList) Get() *PaginatedToolProductSettingsList {
	return v.value
}

func (v *NullablePaginatedToolProductSettingsList) Set(val *PaginatedToolProductSettingsList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedToolProductSettingsList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedToolProductSettingsList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedToolProductSettingsList(val *PaginatedToolProductSettingsList) *NullablePaginatedToolProductSettingsList {
	return &NullablePaginatedToolProductSettingsList{value: val, isSet: true}
}

func (v NullablePaginatedToolProductSettingsList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedToolProductSettingsList) UnmarshalJSON(src []byte) error {
	v.isSet = true
