...
type PaginatedProductAPIScanConfigurationList struct {
	...
	Results []ProductAPIScanConfiguration `json:"results"`
	Prefetch *PaginatedProductAPIScanConfigurationListPrefetch `json:"prefetch,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _PaginatedProductAPIScanConfigurationList PaginatedProductAPIScanConfigurationList
...
func (o *PaginatedProductAPIScanConfigurationList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedProductAPIScanConfigurationList := _PaginatedProductAPIScanConfigurationList{}

	err = json.Unmarshal(data, &varPaginatedProductAPIScanConfigurationList)

	if err != nil {
		return err
	}

	*o = PaginatedProductAPIScanConfigurationList(varPaginatedProductAPIScanConfigurationList)
