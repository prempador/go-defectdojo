...
type _PatchedStubFindingRequest PatchedStubFindingRequest
...
func (o *PatchedStubFindingRequest) UnmarshalJSON(data []byte) (err error) {
	varPatchedStubFindingRequest := _PatchedStubFindingRequest{}

	err = json.Unmarshal(data, &varPatchedStubFindingRequest)

	if err != nil {
		return err
	}

	*o = PatchedStubFindingRequest(varPatchedStubFindingRequest)
