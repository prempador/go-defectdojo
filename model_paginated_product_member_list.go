...
type _PaginatedProductMemberList PaginatedProductMemberList
...
func (o *PaginatedProductMemberList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedProductMemberList := _PaginatedProductMemberList{}

	err = json.Unmarshal(data, &varPaginatedProductMemberList)

	if err != nil {
		return err
	}

	*o = PaginatedProductMemberList(varPaginatedProductMemberList)
