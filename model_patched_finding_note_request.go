...
type _PatchedFindingNoteRequest PatchedFindingNoteRequest
...
func (o *PatchedFindingNoteRequest) UnmarshalJSON(data []byte) (err error) {
	varPatchedFindingNoteRequest := _PatchedFindingNoteRequest{}

	err = json.Unmarshal(data, &varPatchedFindingNoteRequest)

	if err != nil {
		return err
	}

	*o = PatchedFindingNoteRequest(varPatchedFindingNoteRequest)
