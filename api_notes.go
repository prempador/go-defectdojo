...
func (a *NotesAPIService) NotesListExecute(r ApiNotesListRequest) (*PaginatedNoteList, *http.Response, error) {
	...
	if r.editTime != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "edit_time", r.editTime, "")
	}
	if r.edited != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "edited", r.edited, "")
	}
	if r.editor != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "editor", r.editor, "")
	}
	if r.entry != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "entry", r.entry, "")
	}
	if r.id != nil {
